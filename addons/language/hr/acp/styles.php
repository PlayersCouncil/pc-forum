...
'ACP_STYLES_EXPLAIN'=>'Ovdje možeš upravljati dostupnim stilovima.<br />Ne možeš deinstalirati “<strong>prosilver</strong>” stil (a) koji je phpBBov zadan (i) primaran krovni stil.',
...
//'CONFIRM_TEMPLATE_REFRESH'=>'Jesi li siguran/na da želiš osvježiti/zamijeniti sve podatke predloška pohranjene u bazi podataka sa sadržajem datoteka predloška u sustavu datoteka?<br />To će prepisati sve izmijene predloška koje su napravljene uređivačem predloška za vrijeme dok je predložak bio pohranjen u bazi podataka.',
//'CONFIRM_THEME_REFRESH'=>'Jesi li siguran/na da želiš osvježiti/zamijeniti sve podatke teme pohranjene u bazi podataka sa sadržajem datoteka teme u sustavu datoteka?<br />To će prepisati sve izmijene teme koje su napravljene uređivačem teme za vrijeme dok je tema bila pohranjena u bazi podataka.',
...
'DELETE_FROM_FS'=>'Izbriši iz sustava datoteka',
//'DELETE_IMAGESET'=>'Izbriši set slika',
//'DELETE_IMAGESET_EXPLAIN'=>'Ovdje možeš, označen set slika, izbrisati iz baze.<br />Opcionalno, ako imaš dopuštenja, možeš izbrisati set slika iz sustava datoteka. Imaj na umu da nema povratne [undo] mogućnosti što će reći da je set slika izbrisan bespovratno nakon što ga (jednom) izbrišeš. Ne bi bilo zgorega, prvo ga eksportirati, zbog eventualnog budućeg korištenja.',
...
//'DELETE_TEMPLATE_EXPLAIN'=>'Ovdje možeš, označen set predloška, izbrisati iz baze.<br />Opcionalno, ako imaš dopuštenja, možeš izbrisati set iz sustava datoteka. Imaj na umu da nema povratne [undo] mogućnosti što će reći da je predložak izbrisan bespovratno nakon što ga (jednom) izbrišeš. Ne bi bilo zgorega, prvo ga eksportirati, zbog eventualnog budućeg korištenja.',
//'DELETE_THEME'=>'Izbriši temu',
//'DELETE_THEME_EXPLAIN'=>'Ovdje možeš, označenu temu, izbrisati iz baze.<br />Opcionalno, ako imaš dopuštenja, možeš izbrisati temu iz sustava datoteka. Imaj na umu da nema povratne [undo] mogućnosti što će reći da je tema izbrisana bespovratno nakon što ju (jednom) izbrišeš. Ne bi bilo zgorega, prvo ju eksportirati, zbog eventualnog budućeg korištenja.',
...
//'EDIT_DETAILS_TEMPLATE_EXPLAIN'=>'Ovdje možeš uređivati određene detalje predloška poput naziva i sl.<br />Možda (ćeš) imaš (imati) opciju prebacivanja pohranjivanja stylesheeta iz sustava datoteka u bazu podataka i obrnuto (a) što ovisi o PHP konfiguraciji te o tome može li set predloška biti pre(za)pisivan od strane servera.',
//'EDIT_DETAILS_THEME'=>'Uređivanje detalja teme',
//'EDIT_DETAILS_THEME_EXPLAIN'=>'Ovdje možeš uređivati određene detalje teme poput naziva i sl.<br />Možda (ćeš) imaš (imati) opciju prebacivanja pohranjivanja stylesheeta iz sustava datoteka u bazu podataka i obrnuto (a) što ovisi o PHP konfiguraciji te o tome može li stylesheet biti pre(za)pisivan od strane servera.',
...
//'EDIT_THEME_STORE_PARSED'=>'Tema zahtjeva parsiranje stylesheeta (a) što je moguće samo ako je pohranjen u bazi.',
//'EDITOR_DISABLED'=>'Uređivač predložaka je onemogućen.',
//'EXPORT'=>'Eksportiraj',
//'FOREGROUND'=>'Prednji plan',
//'FONT_COLOUR'=>'Boja fonta',
//'FONT_FACE'=>'Naziv fonta',
//'FONT_FACE_EXPLAIN'=>'Možeš navesti više fontova, odvojivši ih zarezom.<br />Ako korisnik/ca nema prvi font s popisa instaliran, sljedeći (koji ima instaliran) će biti izabran.',
...
//'IMAGESET_ADDED'=>'Dodan je novi set slika u sustav datoteka.',
//'IMAGESET_ADDED_DB'=>'Dodan je novi set slika u bazu podataka.',
//'IMAGESET_DELETED'=>'Set slika je izbrisan.',
//'IMAGESET_DELETED_FS'=>'Set slika je izbrisan iz baze podataka, no, postoji mogućnost da su neke slike ostale u sustavu datoteka',
...
//'INSTALL_STYLE_EXPLAIN'=>'Ovdje možeš instalirati stil i odgovarajuće/pripadajuće mu elemente.<br />Ako si već instalirao/la odgovarajuće/pripadajuće elemente stila, neće biti prepisani. Neki stilovi zahtijevaju da elementi budu unaprijed instalirani [ako pokušavaš instalirati takav stil, a nemaš potrebne elemente, bit ćeš obaviješten/a o tome].',
'INSTALL_STYLES'=>'Instaliraj stil/ove',
'INSTALL_STYLES_EXPLAIN'=>'Ako ne možeš (pro)naći određeni stil na listi ispod, provjeri je li stil već instaliran, ako nije instaliran, provjeri ispravnost pohranjivanja.',
...
//'NO_IMAGESET'=>'Nije moguće pronaći set slika u sustavu datoteka.',
//'NO_IMAGE'=>'/',
//'NO_IMAGE_ERROR'=>'Nije moguće pronaći sliku u sustavu datoteka.',
'NO_MATCHING_STYLES_FOUND'	=>'Niti jedan stil ne odgovara zadanim parametrima pretraživanja.',
//'NO_STYLE'=>'Nije moguće pronaći stil u sustavu datoteka.',
//'NO_TEMPLATE'=>'Nije moguće pronaći predložak u sustavu datoteka.',
//'NO_THEME'=>'Nije moguće pronaći temu u sustavu datoteka.',
...
//'STORE_FILESYSTEM'=>'Sustav datoteka',
...
'STYLE_VERSION'=>'Verzija stila',
//'TEMPLATE_ADDED'=>'Set predloška je dodan i pohranjen u sustav datoteka.',
...
//'TEMPLATE_DELETED_FS'=>'Set predloška je izbrisan iz baze, ali je moguće da su pojedine datoteke ostale u sustavu datoteka.',
...
//'TEMPLATE_LOCATION_EXPLAIN'=>'Slike su uvijek pohranjene u sustavu datoteka.',
...
//'THEME_ADDED'=>'Dodana je nova tema u sustav datoteka.',
...
//'THEME_DELETED_FS'=>'Tema je izbrisana iz baze, ali su datoteke ostale u sustavu datoteka.',
...
//'THEME_ERR_REFRESH_FS'=>'Tema je pohranjena u sustavu datoteka poradi čega nema potrebe za osvježavanjem.',
...
//'THEME_LOCATION_EXPLAIN'=>'Slike su uvijek pohranjene u sustavu datoteka.',
...
//'UNSET'=>'Nedefinirano',
'UNINSTALL_PROSILVER'=>'Ne možeš deinstalirati stil “prosilver”.',
'UNINSTALL_DEFAULT'=>'Ne možeš deinstalirati zadani stil.',
'BROWSE_STYLES_DATABASE'=>'Pregledaj bazu podataka stilova',
]);
