...
'CONFIRM_SEARCH_BACKEND'=>'Jesi li siguran/na da želiš prebaciti forum na drugi backend pretraživanja?<br />Nakon promjene backenda pretraživanja, trebat ćeš kreirati indeks za novi backend pretraživanja.<br />Ako nemaš namjeru prebaciti forum na stari backend pretraživanja, možeš izbrisati indeks starog backenda.',
'CONTINUE_DELETING_INDEX'=>'Nastavi prethodan proces izbrisivanja indeksa',
'CONTINUE_DELETING_INDEX_EXPLAIN'=>'Započeo je proces izbrisivanja indeksa.<br />Ako želiš pristupiti početnoj stranici pretraživanja, trebaš ili završiti proces ili ga prekinuti.',
'CONTINUE_INDEXING'=>'Nastavi prethodan proces indeksiranja',
'CONTINUE_INDEXING_EXPLAIN'=>'Započeo je proces indeksiranja.<br />Ako želiš pristupiti početnoj stranici pretraživanja, trebaš ili završiti proces ili ga prekinuti.',
'CREATE_INDEX'=>'Kreiraj indeks',
'DEFAULT_SEARCH_RETURN_CHARS'=>'Zadani broj prikazanih znakova',
'DEFAULT_SEARCH_RETURN_CHARS_EXPLAIN'=>'Zadani broj znakova koji će biti prikazani prilikom pretraživanja [0=prikaz cijelog posta].',
...
'FULLTEXT_MYSQL_NOT_SUPPORTED'=>'MySQL fulltext indeksi mogu biti korišteni samo s MyISAM ili InnoDB [MySQL 5.6.8 i novije verzije] tablicama.',
...
//'FULLTEXT_MYSQL_MBSTRING_EXPLAIN'=>'Ako PCRE nema svojstva unicode znakova, backend pretraživanja će pokušati koristiti mbstringov regularni <em>expression engine</em>.',
//'FULLTEXT_MYSQL_PCRE_EXPLAIN'=>'Ovaj backend pretraživanja zahtijeva PCRE svojstva unicode znakova, dostupno samo u PHP 4.4, 5.1 i novijim verzijama, ako se želi (pre)traži(va)ti non-latin znakove.',
'FULLTEXT_MYSQL_MIN_SEARCH_CHARS_EXPLAIN'=>'Riječi s najmanje “ovoliko” znakova će biti indeksirane za pretraživanje. <br />Samo hoster/ti može/š promijeniti ove postavke mijenjanjem postavki mysql konfiguracije.',
...
'FULLTEXT_SPHINX_INDEXER_MEM_LIMIT_EXPLAIN'=>'Ovaj broj bi cijelo vrijeme trebao biti niži od dostupnog RAMa na “mašini”. Ako dođe/dolazi do problema s performansama, obrati pažnju na korištenje resursa od strane indeksa pretraživanja te snizi memorijski limit.',
...
'LIMIT_SEARCH_LOAD_EXPLAIN'=>'Ako prosječno jednominutno opterećenje sustava premaši postavljenu vrijednost, stranica će automatski otići offline.<br />Vrijednost od 1.0 jednaka je ~100% iskorištenju [jednog] procesora. Ovo funkcionira samo na UNIX serverima.',
...
'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN'=>'Korisnici/e trebaju upisati najmanje toliko znakova imena kada pretražuju pomoću * [zamjenskog znaka].<br />Ako je ime autora/ice kraće od toliko znakova, moguće je pretraživati upisivanjem kompletnog imena.',
'PROGRESS_BAR'=>'Postotakmjer',
'SEARCH_GUEST_INTERVAL'=>'Zadani razmak pretraživanja za goste',
'SEARCH_GUEST_INTERVAL_EXPLAIN'=>'Broj sekundi koji treba proći između 2 pretraživanja istog/e gosta/ice.<br />Interval se provjerava za sve goste zajedno što znači da ako jedan gost pretražuje forum, svi ostali trebaju čekati dok ne prođe interval.',
...
1=>'Svi postovi do posta id %2$d su indeksirani, od čega %1$d postova je unutar ovog koraka.<br />',
2=>'Svi postovi do posta id %2$d su indeksirani, od čega %1$d postova je unutar ovog koraka.<br />',
// <!-- Kocka je hičena! -->
3=>'Svi postovi do posta id %2$d su indeksirani, od čega %1$d postova je unutar ovog koraka.<br />',
),
'SEARCH_INDEX_CREATE_REDIRECT_RATE'=> array(
1=>'Trenutna stopa indeksiranja je otprilike %1$.1f posta/ova po sekundi.',
2=>'Trenutna stopa indeksiranja je otprilike %1$.1f posta/ova po sekundi.',
3=>'Trenutna stopa indeksiranja je otprilike %1$.1f posta/ova po sekundi.',
),
'SEARCH_INDEX_DELETE_REDIRECT'=> array(
1=>'Svi postovi do posta id %2$d su izbrisani iz indeksa pretraživanja, od kojih %1$d post u ovom koraku.<br />',
2=>'Svi postovi do posta id %2$d su izbrisani iz indeksa pretraživanja, od kojih %1$d posta u ovom koraku.<br />',
3=>'Svi postovi do posta id %2$d su izbrisani iz indeksa pretraživanja, od kojih %1$d postova u ovom koraku.<br />',
),
'SEARCH_INDEX_DELETE_REDIRECT_RATE'=> array(
1=>'Trenutna brzina izbrisivanja je aproksimativno %1$.1f postova u sekundi.',
2=>'Trenutna brzina izbrisivanja je aproksimativno %1$.1f postova u sekundi.',
3=>'Trenutna brzina izbrisivanja je aproksimativno %1$.1f postova u sekundi.',
),
'SEARCH_INDEX_CREATED'=>'Svi postovi baze podataka foruma su indeksirani.',
'SEARCH_INDEX_PROGRESS'=>'Gotovo: %1$d | Na čekanju: %2$d | Ukupno: %3$d',
...
'YES_SEARCH_UPDATE_EXPLAIN'=>'Ažuriranje fulltext indeksa prilikom postanja, zanemareno je ako je pretraživanje onemogućeno.',
));
