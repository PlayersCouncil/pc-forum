...
'GROUP_COLOR_EXPLAIN'=>'Definira boju kojom će biti prikazana korisnička imena članova/ica grupe.<br />Ako želiš da se korisnička imena članova/ica grupe prikazuju u skladu sa zadanim [im] postavkama, ostavi praznim [nemoj upisati boju].',
...
'GROUP_LIST_EXPLAIN'=>'Ispod se nalazi kompletan popis svih članova/ica grupe.<br />Ovdje možeš dodavati nove članove/ice odnosno izbrisati stare [osim ako se radi o određenoj specijalnoj grupi].',
'GROUP_MEMBERS'=>'Članovi/ce grupe',
'GROUP_MEMBERS_EXPLAIN'=>'Ispod se nalazi kompletan popis svih članova/ica grupe.<br />Uključuje odvojene odjeljke za vođe, članove/ice “na čekanju” i [stvarne] članove/ice.<br />Odavde možeš upravljati svim aspektima (a) vezano uz to tko je korisnik/ca grupe i koju ulogu [u grupi] ima. Ako vođu grupe želiš smijeniti s položaja, ali ne i isključiti iz grupe, možeš to opcijom <em>Smijeni s položaja vođe grupe</em>. Želiš li člana/icu grupe imenovati vođom grupe, možeš to opcijom <em>Postavi za vođu grupe</em>.',
'GROUP_MESSAGE_LIMIT'=>'Privatnu(e) poruku(e) grupe ograniči na mapu(e)',
'GROUP_MESSAGE_LIMIT_EXPLAIN'=>'Ove postavke prepisuju [dotadašnje] postavke korisnika/ce (a) vezane uz ograničenje(a) mapa poruka.<br />Maksimum svih grupa korisnika/ce bit će korišten za određivanje vrijednosti.<br />0=postavke svih članova/ica grupe bit će prepisane postavkama foruma.',
...
'GROUP_NAME_TAKEN'=>'Naziv grupe koji si upisao/la već postoji.<br />Izaberi alternativu.',
'GROUP_OPEN'=>'Otvorena',
'GROUP_PENDING'=>'Članovi/ce “na čekanju”',
'GROUP_MAX_RECIPIENTS'=>'Maksimalan broj dopuštenih primatelja/ica po privatnoj poruci',
'GROUP_MAX_RECIPIENTS_EXPLAIN'=>'Maksimalan broj dopuštenih primatelja/ica po svakoj privatnoj poruci.<br />Maksimum svih grupa korisnika/ce bit će korišten za određivanje vrijednosti.<br />0=postavke svih članova/ica grupe bit će prepisane postavkama foruma.',
'GROUP_OPTIONS_SAVE'=>'Mogućnosti širine grupe',
'GROUP_PROMOTE'=>'Postavi za vođu grupe',
'GROUP_RANK'=>'Status grupe',
'GROUP_RECEIVE_PM'=>'Grupa može primati privatne poruke',
'GROUP_RECEIVE_PM_EXPLAIN'=>'Bez obzira na omogućavanje primanja privatnih poruka grupi, ako se radi o skrivenoj grupi, tada, grupi neće moći biti (po)slane poruke.',
'GROUP_REQUEST'=>'Na zahtjev',
'GROUP_SETTINGS_SAVE'=>'Globalne postavke grupe',
'GROUP_SKIP_AUTH'=>'Izuzmi vođu grupe od dopuštenja',
'GROUP_SKIP_AUTH_EXPLAIN'=>'Ako je omogućeno, vođa grupe više neće nasljeđivati dopuštenja grupe.',
...
// <!-- Kocka je hičena! -->
'GROUP_USERS_INVALID'=>'Niti jedan/na korisnik/ca nije dodan/a grupi jer ne postoje korisnička imena: %s.',
...
'LEGEND_SORT_GROUPNAME_EXPLAIN'=>'Ako je omogućeno, redoslijed ispod će biti ignoriran.',
...
'PENDING_MEMBERS'=>'Članovi/ce “na čekanju”',
...
'TEAMPAGE_FORUMS_EXPLAIN'=>'Ako je omogućeno, moderatorima/cama će, na popisu Članstva, u retku pored njihovog korisničkog imena, biti izlistan popis svih tematskih foruma koje moderiraju, (a) što može biti (pre)zahtjevno za baze velikih foruma.',
