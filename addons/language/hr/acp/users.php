...
'AT_LEAST_ONE_FOUNDER'=>'Ne možeš promijeniti ovog/u korisnika/cu iz osnivača/ice u običnog/u korisnika/cu.<br />Na forumu treba postajati najmanje jedan korisnički račun s osnivačkim statusom.<br />Ako želiš promijeniti status [korisnika/ce] iz osnivača/ice u neki drugi, prvo trebaš promovirati [nekog/u] drugog/u korisnika/cu u osnivača/icu.',
...
'CANNOT_FORCE_REACT_BOT'=>'Nemaš dopuštenje za forsiranje reaktivacije računa robota.<br />Umjesto toga, možeš reaktivirati samog/e robota/e sa/na stranici robota.',
'CANNOT_FORCE_REACT_FOUNDER'=>'Nemaš dopuštenje za forsiranje reaktivacije korisničkog/ih računa osnivača/ica foruma.',
'CANNOT_FORCE_REACT_YOURSELF'=>'Nemaš dopuštenje za forsiranje reaktivacije korisničkog računa samog/e sebe.',
...
'CONFIRM_EMAIL_EXPLAIN'=>'Ako si [iznad] promijenio/la adresu elektroničke pošte, potvrdi ju.',
'DELETE_POSTS'=>'Izbriši postove',
'DELETE_USER'=>'Izbriši korisnički račun',
'DELETE_USER_EXPLAIN'=>'Ova operacija ne može biti poništena što će reći da “nema povratka na prijašnje stanje” ako izbrišeš [neki/nečiji] korisnički račun.<br />Nepročitane privatne poruke poslane od [tog/te] korisnika/ce bit će izbrisane [nepročitane] iz sandučića primatelja/ice(a).',
// <!-- Kocka je hičena! -->
