...
'BBCODE_DANGER'=>'BBKod koji pokušavaš dodati čini se da predstavlja potencijalan sigurnosni problem.<br />Ukoliko BBCode koristi {TEXT} token u osjetljivom kontekstu, pokušaj s restriktivnijim tipovima.<br />Nastavi samo ako razumiješ o kolikom se sigurnosnom riziku radi.',
...
'BBCODE_INVALID_TEMPLATE'=>'BBCode predložak je neispravan.',
'BBCODE_TAG'=>'Tag',
'BBCODE_TAG_TOO_LONG'=>'Naziv taga BBKoda je predugačak.',
...
'TOKEN'=>'Token',
'TOKENS'=>'Tokeni',
'TOKENS_EXPLAIN'=>'Tokeni su rezervirana mjesta za korisničke upise.<br />Upisi će biti potvrđeni samo ako odgovaraju pratećoj definiciji. Ako je potrebno, možeš ih pobrojati dodavanjem broja zadnjem znaku između vitičastih zagrada, npr. {TEXT1}, {TEXT2}.<br /><br />Možeš koristiti bilo koji jezični niz podataka koji postoji u tvojoj jezičnoj mapi, npr., kao: {L_<em>&lt;STRINGNAME&gt;</em>} gdje je <em>&lt;STRINGNAME&gt;</em> naziv prevedenog niza podataka koji želiš dodati. Na primjer: {L_WROTE} će biti prikazano kao &quot;wrote&quot; odnosno kao prijevod [toga] ovisno o kojem se jezičnom paketu radi.<br /><br /><strong>Samo ispod izlistani tokeni mogu biti korišteni.</strong>',
...
'tokens'=>array(
'TEXT'=>'Bilo koji/kakav tekst, uključujući strane znakove, brojeve itd.',
...
'URL'=>'Valjan URL koji koristi bilo koji dopušten protokol [http, ftp i sl. ne mogu biti korišteni za izvršavanje javascripta]. Ako ništa nije postavljeno, &quot;http://&quot; će biti [stavljen ispred] dodan nizu podataka.',
...
$lang = array_merge($lang, array(
'ACP_DISALLOW_EXPLAIN'=>'Ovdje možeš kontrolirati korisnička imena kojima neće biti dopušteno korištenje.<br />Možeš koristiti i zvjezdice (*) [koje zamjenjuju bilo koji znak].<br />Nećeš moći upisati niti jedno korisničko ime koje je već registrirano [ako to želiš, trebaš prvo promijeniti/izbrisati postojeće korisničko ime].',
...
'IS_NOT_TRANSLATED_EXPLAIN'=>'Razlog <strong>nije</strong> lokaliziran.<br />Ako želiš lokaliziran oblik, odredi točan ključ iz sekcije razloga prijave(a) jezičnih datoteka.',
'IS_TRANSLATED'=>'Razlog je lokaliziran.',
'IS_TRANSLATED_EXPLAIN'=>'Razlog <strong>je</strong> lokaliziran.<br />Ako je naslov koji upišeš naveden u sekciji razloga prijave(a) jezičnih datoteka, bit će korišteni lokalizirani oblici naziva i opisa.',
...
'REASON_EDIT_EXPLAIN'=>'Ovdje možeš dodati/uređivati razlog(e).<br />Ako je razlog preveden, bit će korištena lokalizirana verzija umjesto opisa upisanog(ih) ovdje.',
