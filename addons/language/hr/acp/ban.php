...
'30_MINS'=>'30 minuta',
'6_HOURS'=>'6 sati',
'ACP_BAN_EXPLAIN'=>'Ovdje možeš upravljati isključivanjem korisnika/ca i to preko korisničkih imena, IP odnosno adresa elektroničke pošte.<br />Time ćeš onemogućiti pristupanje korisniku/ci bilo kojem dijelu foruma.<br />Ako želiš, možeš dati kratak [maksimalno 3000 znakova] razlog isključenja [što će biti evidentirano u administratorskim zapisima].<br />Možeš određivati dužinu isključenja, npr. ako želiš isključiti korisnika/cu, ne na npr. 3 mjeseca, već npr. do određenog datuma, izabrat ćeš <span style="text-decoration: underline;">Do -&gt;</span> te upisati datum u <kbd>GGGG-MM-DD</kbd> formatu.',
...
'EMAIL_BAN_EXCLUDE_EXPLAIN'=>'Omogući ovu opciju ako želiš izuzeti upisanu/e adresu/e elektroničke pošte od svih trenutnih isključenja.',
'EMAIL_BAN_EXPLAIN'=>'Ako želiš upisati više adresa elektroničke pošte, upiši svaku u novi redak.<br />Možeš koristiti * kao zamjenski znak, npr. <samp>*@hotmail.com</samp>, <samp>*@*.domena.adr</samp>, itd.',
...
'IP_BAN_EXCLUDE_EXPLAIN'=>'Omogući ovu opciju ako želiš izuzeti upisanu/e IP adresu/e od svih trenutnih isključenja.',
'IP_BAN_EXPLAIN'=>'Ako želiš upisati više IP adresa, upiši svaku u novi redak.<br />Za određivanje raspona IP adresa, početak i kraj odvoji rastavnicom (-). Možeš koristiti * kao zamjenski znak.',
...
'PERMANENT'=>'Stalno',
'UNTIL'=>'Do',
'USER_BAN'=>'Isključivanje korisnika/ce(a) po korisničkom/im imenu/ima',
'USER_BAN_EXCLUDE_EXPLAIN'=>'Omogući ovu opciju ako želiš izuzeti upisano/e korisničko/a ime/na od svih trenutnih isključenja.',
'USER_BAN_EXPLAIN'=>'Ako želiš upisati više korisničkih imena, upiši svako u novi redak.<br />Za automatsko dodavanje korisničkih imena možeš koristiti <span style="text-decoration: underline;">Pronađi korisničko ime</span> funkciju.',
