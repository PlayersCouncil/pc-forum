...
'ACP_BACKUP'=>'Backup [izrada zaštitnog preslika]',
...
'ACP_FORUM_PERMISSIONS_COPY'=>'Preslikavanje forumskih dopuštenja',
...
'BACK'=>'Natrag',
'CONTAINER_EXCEPTION' =>'Došlo je do greške prilikom kreiranja spremnika vezanog uz instaliranu ekstenziju (a)	poradi čega su sve instalirane ekstenzije [privremeno] onemogućene.<br />Pokušaj isprazniti priručnu memoriju foruma.<br />Sve instalirane ekstenzije će automatski biti [ponovo] omogućene čim greška bude ispravljena.<br />Ako greška ne bude ispravljena odnosno ako se greška ponovo pojavi, posjeti <a href="https://www.phpbb.com/support">phpBB.com</a> za podršku.',
'EXCEPTION' =>'Iznimka',
...
'CSV_INVALID'=>'Upisana zarezom-odvojena postavka “%1$s” je neispravna.<br />Vrijednosti bi trebale biti ograničene samo zarezom, ne bi trebale sadržavati sadržavati početne ili prateće graničnike.',
...
'REMIND'=>'Podsjeti',
'REPARSE_LOCK_ERROR'=>'Reparsiranje je [već] u tijeku [od strane (nekog) drugog procesa].',
...
'URL_INVALID'=>'URL upisan za postavku “%1$s” je neispravan.',
'URL_SCHEME_INVALID'=>'Upisana shema “%2$s” u zarezom-odvojenoj postavci “%1$s” je neispravna.<br />Shema bi trebala započeti latiničnim znakom slijeđenim alfanumeričkim znakovima, crticama ili točkama.',
'USERNAMES_EXPLAIN'=>'Upiši svako korisničko ime u novi redak.',
'USER_CONTROL_PANEL'=>'Korisnički profil/postavke',
'UPDATE_NEEDED'=>'Forum nije <em>up to date</em> [najnoviji].',
'UPDATE_NOT_NEEDED'=>'Forum je <em>up to date</em> [najnoviji].',
...
$lang = array_merge($lang, array(
'ACP_ADMIN_LOGS_EXPLAIN'=>'Ovdje su izlistane radnje izvršene od strane administratora/ica.<br />Možeš ih poredati po korisničkom imenu, datumu, IP adresi odnosno radnji.<br />Ako imaš potrebita dopuštenja, možeš izbrisati pojedine zapise odnosno cijelu listu.',
'ACP_CRITICAL_LOGS_EXPLAIN'=>'Ovdje su izlistane radnje izvršene od strane samog foruma.<br />Zapisi pružaju informacije koje, u pravilu, služe za rješavanje specifičnih problema [npr. neisporučene poruke elektroničkom poštom].<br />Možeš ih poredati po korisničkom imenu, datumu, IP adresi odnosno radnji.<br />Ako imaš potrebita dopuštenja, možeš izbrisati pojedine zapise odnosno cijelu listu.',
'ACP_MOD_LOGS_EXPLAIN'=>'Ovdje su izlistane radnje izvršene od strane moderatora/ica.<br />Možeš ih poredati po korisničkom imenu, datumu, IP adresi odnosno radnji.<br />Ako imaš potrebita dopuštenja, možeš izbrisati pojedine zapise odnosno cijelu listu.',
...
'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'=>'<var>mbstring.http_input</var> treba biti ostavljena praznom.<br />Trenutnu vrijednost možeš provjeriti [vidjeti] na <samp>PHP info</samp> stranici.',
'ERROR_MBSTRING_HTTP_OUTPUT'=>'HTTP <em>izlaz</em> konverzije znakova je nepravilno postavljen.',
'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'=>'<var>mbstring.http_output</var> treba biti ostavljena praznom.<br />Trenutnu vrijednost možeš provjeriti [vidjeti] na <samp>PHP info</samp> stranici.',
'ERROR_DEFAULT_CHARSET'=>'Zadani znakovni set je nepravilno postavljen.',
'ERROR_DEFAULT_CHARSET_EXPLAIN'=>'<var>zadani znakovni set</var> treba biti postavljen na <samp>UTF-8</samp>.<br />Trenutnu vrijednost možeš provjeriti [vidjeti] na <samp>PHP information</samp> stranici.',
...
'PHP_VERSION_OLD'=>'Verzija PHPa, koja se trenutno nalazi na serveru (%1$s), neće [više] biti podržana od, [strane] budućih verzija phpBBa. Minimalna zahtijevana verzija bit će PHP %2$s. %3$sDetalji%4$s',
...
'VERSIONCHECK_INVALID_ENTRY'=>'Dobivanje informacija o najnovijoj verziji sadrži nepodržan unos.',
'VERSIONCHECK_INVALID_URL'=>'Dobivanje informacija o najnovijoj verziji sadrži neispravan URL.',
'VERSIONCHECK_INVALID_VERSION'=>'Dobivanje informacija o najnovijoj verziji sadrži neispravnu verziju.',
...
'LOG_ACL_ADD_USER_LOCAL_F_'=>'<strong>Dodan ili uređen korisnički forumski pristup</strong> u %1$s<br />» %2$s',
'LOG_ACL_ADD_USER_LOCAL_M_'=>'<strong>Dodan ili uređen korisnički forumski moderatorski pristup</strong> u %1$s<br />» %2$s',
'LOG_ACL_ADD_GROUP_LOCAL_F_'=>'<strong>Dodan ili uređen grupni forumski pristup</strong> u %1$s<br />» %2$s',
'LOG_ACL_ADD_GROUP_LOCAL_M_'=>'<strong>Dodan ili uređen grupni forumski moderatorski pristup</strong> u %1$s<br />» %2$s',
'LOG_ACL_ADD_MOD_LOCAL_M_'=>'<strong>Dodani/e ili uređeni/e moderatori/ce</strong> za %1$s<br />» %2$s',
'LOG_ACL_ADD_FORUM_LOCAL_F_'=>'<strong>Dodana ili uređena dopuštenja foruma</strong> za %1$s<br />» %2$s',
...
'LOG_BBCODE_CONFIGURATION_ERROR'=>'<strong>Greška prilikom konfiguriranja BBKoda</strong>: %1$s<br />» %2$s',
...
'LOG_FORK'=>'<strong>Preslikana tema</strong><br />» iz %s',
...
'LOG_FORUM_COPIED_PERMISSIONS'=>'<strong>Preslikana forumska dopuštenja</strong> iz %1$s<br />» %2$s',
...
//'LOG_IMAGESET_ADD_FS'=>'<strong>U sustav datoteka dodan novi set slika</strong><br />» %s',
...
'LOG_IP_BROWSER_FORWARDED_CHECK'=>'<strong>Provjera sesije IP adrese/preglednika/X_FORWARDED_FOR neuspjela</strong><br />»IP adresa korisnika/ce “<em>%1$s</em>” provjerena u odnosu na sesiju IP adrese “<em>%2$s</em>”, niz podataka preglednika korisnika “<em>%3$s</em>” provjeren u odnosu na sesiju niza podataka preglednika “<em>%4$s</em>” i korisnikov/čin X_FORWARDED_FOR niz podataka “<em>%5$s</em>” provjeren u odnosu na sesiju X_FORWARDED_FOR niza podataka “<em>%6$s</em>”.',
...
'LOG_SPAMHAUS_OPEN_RESOLVER'=>'Spamhaus ne dopušta upite koji koriste otvoreni razrješivač. Provjera crne liste je onemogućena. Za više informacija baci pogled na: https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
'LOG_SPAMHAUS_VOLUME_LIMIT'=>'Spamhaus ograničenje količine upita je premašeno. Provjera crne liste je onemogućena. Za više informacija baci pogled na: https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
...
'LOG_TEMPLATE_ADD_FS'=>'<strong>Dodan novi set predloška u sustav datoteka</strong><br />» %s',
...
'LOG_THEME_ADD_FS'=>'<strong>Dodana nova tema u sustav datoteka</strong><br />» %s',
...
3 =>'<strong>Izbrisano %2$d upozorenja korisniku(cima)/ci(cama)</strong><br />» %1$s',
),
...
'LOG_EXT_UPDATE'=>'<strong>Ekstenzija ažurirana</strong><br />» %s',
));
