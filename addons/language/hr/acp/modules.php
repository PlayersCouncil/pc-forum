...
'ACP_MODULE_MANAGEMENT_EXPLAIN'=>'Ovdje možeš upravljati svim vrstama modula.<br />AF ima trorazinsku izborničku strukturu [Kategorija -> Kategorija -> Modul] čime ostalo ima dvorazinsku izborničku strukturu [Kategorija -> Modul] koja treba biti zadržana.<br />Ako onemogućiš odnosno izbrišeš module odgovorne za upravljanje modulima, nastat će problemi.',
...
'MODULE_DISPLAYED_EXPLAIN'=>'Ako ne želiš da ovaj modul bude prikazan, ali ga želiš koristiti, postavi [ovo] na “Ne”.',
// <!-- Kocka je hičena! -->
'MODULE_EDITED'=>'Modul je uređen.',
'MODULE_ENABLED'=>'Omogući modul',
'MODULE_LANGNAME'=>'Jezični naziv modula',
'MODULE_LANGNAME_EXPLAIN'=>'Upiši prikazani naziv modula.<br />Ako je modul povezan s jezičnom datotekom, koristi jezičnu konstantu.',
'MODULE_TYPE'=>'Tip modula',
'NO_CATEGORY_TO_MODULE'=>'Nije bilo moguće pretvoriti kategoriju u modul.<br />Ako želiš izvesti ovu radnju, trebaš izbrisati/premjestiti sve podmodule modula.',
