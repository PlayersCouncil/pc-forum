...
'DISPLAY_AT_PROFILE_EXPLAIN'=>'Ako je omogućeno, korisnik/ca će moći mijenjati korisničko polje u korisničkom Profilu/Postavkama.',
'DISPLAY_AT_REGISTER'=>'Prikaži prilikom registracije',
'DISPLAY_AT_REGISTER_EXPLAIN'=>'Ako je omogućeno, korisničko polje bit će prikazano prilikom registracije.',
'DISPLAY_ON_MEMBERLIST'=>'Prikaži na popisu Članstva',
'DISPLAY_ON_MEMBERLIST_EXPLAIN'=>'Ako je omogućeno, polje će biti prikazano, na popisu Članstva, u retku pored korisničkog imena korisnika/ce.',
'DISPLAY_ON_PM'=>'Prikaži u privatnim porukama',
'DISPLAY_ON_PM_EXPLAIN'=>'Ako je omogućeno, polje će biti prikazano, u mini profilu, kod prikazivanja privatnih poruka.',
'DISPLAY_ON_VT'=>'Prikaži na “zaslonu” tema/e',
'DISPLAY_ON_VT_EXPLAIN'=>'Ako je omogućeno, polje će biti prikazano u mini-profilu na “zaslonu” tema/e.',
'DISPLAY_PROFILE_FIELD'=>'Prikaži korisničko polje',
'DISPLAY_PROFILE_FIELD_EXPLAIN'=>'Korisničko polje bit će prikazano na svim dopuštenim mjestima, ako [će biti] je omogućeno u <em>Ostalim postavkama</em>.<br />Postavljanje opcije na "Ne" rezultirat će skrivanjem polja na stranicama tema, korisničkim profilima i popisu Članstva.',
'DROPDOWN_ENTRIES_EXPLAIN'=>'Upiši opcije, svaku u novi redak.',
'EDIT_DROPDOWN_LANG_EXPLAIN'=>'Možeš mijenjati opcije te dodavati nove.<br />Prilikom dodavanja novih opcija, nije preporučljivo umetati ih između već postojećih već, dodavati ih na kraj da ne bi došlo do netočnog opcioniranja kod korisnika/ca [isto vrijedi i za izbrisivanje opcija (s time da kod izbrisivanja treba obratiti pažnju na to da će korisniku/ci, ako je izbrisana opcija koju je izabrao/la, “izabranom” opcijom postati zadana opcija)].',
...
'HIDE_PROFILE_FIELD_EXPLAIN'=>'Ako je omogućeno, korisničko polje bit će prikazano samo administratori(ca)ma/moderatori(ca)ma.<br />Ako je onemogućen prikaz u korisničkom Profilu/Postavkama, korisnik/ca neće moći vidjeti/uređivati polje (a) što će moći [samo] administratori(ce)/moderatori(ce).',
...
'NO_VALUE_OPTION_EXPLAIN'=>'Vrijednost za neupisano.<br />Ako je polje obvezno, korisnik/ca dobiva grešku ako izabere ovdje izabranu opciju.',
...
'REQUIRED_FIELD_EXPLAIN'=>'Korisničko polje treba biti ispunjeno ili određeno od strane korisnika/ce odnosno administratora/ice.<br />Ako je onemogućen prikaz prilikom registracije, polje će trebati biti ispunjeno/određeno [samo] prilikom uređivanja profila od strane korisnika/ce.',
'ROWS'=>'Redci',
'SAVE'=>'Pohrani',
'SECOND_OPTION'=>'Druga opcija',
'SHOW_NOVALUE_FIELD'=>'Prikaži polje ako vrijednost nije izabrana',
'SHOW_NOVALUE_FIELD_EXPLAIN'=>'Određuje hoće li korisničko polje biti prikazano ako vrijednost nije izabrana za neobvezna polja odnosno ako vrijednost još nije izabrana za obvezna polja.',
...
'STEP_3_EXPLAIN_CREATE'=>'Obzirom da je instalirano više od jednog jezičnog paketa, trebaš upisati preostale jezične stavke.<br />Korisničko polje će raditi s omogućenim zadanim jezikom.',
'STEP_3_EXPLAIN_EDIT'=>'Obzirom da je instalirano više od jednog jezičnog paketa, možeš mijenjati/dodavati (pre)ostale jezične stavke.<br />Ako ne izmijeniš/dodaš (pre)ostale jezične stavke, korisničko polje će raditi s postavkama zadanog jezika.',
