...
'ALLOWED_FORUMS_EXPLAIN'=>'Dopušteno dodavanje dodijeljenih ekstenzija na izabranom/odabranim [ili svima ako su svi odabrani] forumu/ima.',
...
'DISPLAY_INLINED_EXPLAIN'=>'Ako je postavljeno na “Ne”, privitci sa slikama bit će prikazani kao linkovi.',
...
'EXCLUDE_ENTERED_IP'=>'Omogući ako želiš izuzeti upisanu/o IP adresu/ime hosta.',
...
'IMAGE_LINK_SIZE_EXPLAIN'=>'Ako je veličina slike privitka veća od zadanih dimenzija, umjesto nje bit će prikazan [tekstualni] link.<br />Za onemogućavanje ove opcije, vrijednosti postavi na 0px x 0px.',
'IMAGE_QUALITY'=>'Kvaliteta pohranjenih privitaka slika (samo JPEG)',
'IMAGE_QUALITY_EXPLAIN'=>'Odredi vrijednost između 50% (manja veličina datoteke) i 90% (bolja kvaliteta datoteke) [vrijednosti veće od 90% su onemogućene zbog prevelikog povećavanja veličine datoteka] [primjenjivo samo ako su maksimalne dimenzije datoteke postavljene na vrijednost(i) drugačije od 0px s(a) 0px].',
// <!-- Kocka je hičena! -->
'IMAGE_STRIP_METADATA'=>'Uklanjanje metapodatke slike (samo JPEG)',
'IMAGE_STRIP_METADATA_EXPLAIN'=>'Ukloni Exif metapodatke, npr. ime autora/ice, GPS koordinate i detalji kamere, [primjenjivo samo ako su maksimalne dimenzije datoteke postavljene na vrijednost(i) drugačije od 0px s(a) 0px].',
...
'MAX_THUMB_WIDTH'=>'Maksimalna širina/visina minijature u pikselima',
...
'NO_EXT_GROUP'=>'/',
'NO_EXT_GROUP_ALLOWED_PM'=>'Nema <a href="%s">dopuštenih grupa ekstenzija</a> za privatne poruke.',
'NO_EXT_GROUP_ALLOWED_POST'=>'Nema <a href="%s">dopuštenih grupa ekstenzija</a> za postove.',
...
'UPLOAD_DIR_EXPLAIN'=>'Putanja do mape za pohranjivanje privitaka.<br />Ako promijeniš mapu za pohranjivanje privitaka, a u prvotnoj [staroj mapi] su [u nju već] bili pohranjeni privitci, trebat ćeš ih ručno preslikati u drugu [novu mapu].',
'UPLOAD_ICON'=>'Ikona pohranjivanja',
'UPLOAD_NOT_DIR'=>'Lokacija za pohranjivanje koju si upisao/la ne vodi do mape.',
'UPLOAD_POST_NOT_EXIST'=>'Datoteka “%1$s” ne može biti pohranjena u post broj %2$d jer post ne postoji.',
));
