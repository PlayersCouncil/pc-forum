...
'CONFIRM_QUESTION_MISSING'=>'Nije [bilo] moguće dohvatiti/(po)vratiti pitanja za <em>captchau</em>.<br />Molim(o), kontaktiraj administratora/icu foruma.',
...
'QUESTIONS'=>'Pitanja',
'QUESTIONS_EXPLAIN'=>'Za izvršenje svake radnje, preduvjet izvršenja koje je uporaba Q&amp;A dodatka, korisnici/e će biti upitani/e jedno od, ovdje upisanih, pitanja.<br />Da bi ovaj dodatak uopće mogao biti uporabljen, na zadanom jeziku, treba biti postavljeno najmanje jedno pitanje.<br />Pitanja bi trebala biti lako razumljiva i odgovorljiva za ciljanu skupinu korisnika/ca [ovog, tvog] foruma, ali, opet, dovoljno teška da bi zlouporaba od strane robota, koji su u stanju izvršavati pretraživanje Google™, bila smanjena na najmanju moguću mjeru.<br />Dovoljno je samo jedno (pogodno) pitanje. Ukoliko se počnu pojavljivati spam registracije, potrebno je promijeniti pitanje.<br />Ako je za pitanja/odgovore na postavljena pitanja potrebna uporaba velikih/malih slova, interpunkcijskih znakova i praznina, trebaš omogućiti postavke stroge provjere.',
...
'QUESTION_STRICT_EXPLAIN'=>'Ako je omogućeno, velika/mala slova, interpunkcijski znakovi i praznine će [moći] biti uporabljeni.',
...
'QA_LAST_QUESTION'=>'Ne možeš izbrisati sva pitanja dok je dodatak aktivan.',
// <!-- Kocka je hičena! -->
));
