...
'USER_LANG'=>'hr',
// Množina: https://area51.phpbb.com/docs/dev/3.3.x/language/plurals.html
'PLURAL_RULE'=> 7,
//'0_DAY'=>'0 dana',
'1_DAY'=>'1 dan',
//'2_DAYS'=>'2 dana',
...
'ALL_TIMES'=>'Vremenska zona: <span title="%2$s">%1$s</span>', // GMT+02:00
'ALL_TOPICS'=>'Sve teme',
...
'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'=>'[Ova vanjska] Usluga je (već) povezana s (drugim) forumskim korisničkim računom.',
...
'AUTH_PROVIDER_OAUTH_ERROR_REQUEST'=>'Došlo je do (po)greške prilikom procesuiranja OAuth zahtjeva.',
'AUTH_PROVIDER_OAUTH_RETURN_ERROR'=>'Vanjska usluga vratila je neispravnu vrijednost poradi čega zahtjev ne može biti procesuiran.',
...
'AVATAR_NO_TEMP_DIR'=>'Mapa za privremenu pohranu avatara nije pronađena ili nije pre(za)pisljiva.',
'AVATAR_NO_SIZE'=>'Ustanovljavanje visine i širine “linkanog” avatara nije uspjelo.<br />Upiši ih “ručno”.',
'AVATAR_NO_UPLOAD_DIR'=>'Putanja pohrane avatara ne postoji ili nije pre(za)pisljiva.',
'AVATAR_NO_UPLOAD_PATH'=>'Pohranjivanje avatara je omogućeno, ali putanja pohrane avatara nije postavljena.',
...
'AVATAR_PHP_UPLOAD_STOPPED'=> 'PHP ekstenzija je zaustavila pohranjivanje avatara.',
...
'CONTACT_US'=>'Kontakt',
'COOKIE_CONSENT_INFO'=>'Ako želiš znati više...',
'COOKIE_CONSENT_MSG'=>'Ove stranice koriste kolačiće (a) poradi osiguranja dobivanja najboljeg iskustva na našim stranicama.',
'COOKIE_CONSENT_OK'=>'Kužim!',
...
'DELETE_COOKIES'=>'Izbriši kolačiće',
...
'EMAIL_SMTP_ERROR_RESPONSE'=>'Došlo je do greške prilikom slanja poruke elektroničkom poštom.<br /><strong>Redak: %1$s</strong>. Odgovaranje: %2$s.',
...
'FEATURE_NOT_AVAILABLE'=>'Zatražena značajka nije dostupna.',
...
'FROM'=>'od',
'FSOCK_DISABLED'=>'Funkcija <var>fsockopen</var> je onemogućena odnosno nije moguće povezati se za serverom poradi čega operaciju nije moguće izvršiti.',
'FSOCK_TIMEOUT'=>'Došlo je do isteka vremena izvršavanja.<br />Pokušaj ponovo kasnije.',
'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'=>'Nije [bilo] moguće promijeniti datoteku grupe.',
'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'=>'Nije [bilo] moguće promijeniti dopuštenja datoteke.',
'FILESYSTEM_CANNOT_COPY_FILES'=>'Nije [bilo] moguće preslikati datoteke.',
'FILESYSTEM_CANNOT_CREATE_SYMLINK'=>'Nije [bilo] moguće kreirati <em>symlink</em>.',
'FILESYSTEM_CANNOT_CREATE_DIRECTORY'=>'Nije [bilo] moguće kreirati mapu.',
// <!-- Kocka je hičena! -->
'FILESYSTEM_CANNOT_DELETE_FILES'=>'Nije [bilo] moguće izbrisati datoteke iz sustava.',
'FILESYSTEM_CANNOT_DUMP_FILE'=>'Nije [bilo] moguće <em>dumpirati</em> datoteku.',
'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'=>'Nije [bilo] moguće <em>mirrorirati</em> mapu.',
'FILESYSTEM_CANNOT_RENAME_FILE'=>'Nije [bilo] moguće preimenovati datoteku iz sustava.',
'FILESYSTEM_CANNOT_TOUCH_FILES'=>'Nije [bilo] moguće kreirati datoteku odnosno izmijeniti vremenske oznake iste.',
...
'INVALID_FEED_ATTACHMENTS'=>'Izabrani <em>feed</em> je pokušao dohvatiti privitke s neispravnim ograničenjem.',
...
'LOGIN_ERROR_PASSWORD'=>'Upisao/la si netočnu zaporku.<br />Provjeri ju i pokušaj ponovo.<br />Ako ti “nikako” ne uspije, kontaktiraj %sadministratora/icu%s.',
'LOGIN_ERROR_PASSWORD_CONVERT'=>'Konvertiranje tvoje zaporke, prilikom ažuriranja softvera foruma, nije uspjelo.<br />%sZatraži novu zaporku%s.<br />Ako ćeš i dalje imati problema s korištenjem foruma, kontaktiraj %sadministratora/icu%s.',
'LOGIN_ERROR_USERNAME'=>'Upisao/la si netočno/neaktivno korisničko ime.<br />Provjeri ga i pokušaj ponovo.<br />Ako ti “nikako” ne uspije, kontaktiraj %sadministratora/icu%s.',
...
'NOT_AUTHORISED'=>'Za pregledavanje ovog dijela foruma, trebaš biti ovlašten/a.',
...
2=>'<strong>Odgovor</strong> korisnika/ce %1$s u bookmarkiranoj temi:',
3=>'<strong>Odgovor</strong> korisnika/ce %1$s u bookmarkiranoj temi:',
),
...
'NOTIFICATION_METHOD_INVALID'=>'"%s" metoda se ne odnosi na valjane metode obavješćivanja.',
'NOTIFICATION_PM'=>'<strong>Privatna poruka</strong> od korisnika/ce %1$s:',
'NOTIFICATION_POST'=> array(
1=>'<strong>Odgovor</strong> korisnika/ce %1$s u temi:',
2=>'<strong>Odgovor</strong> korisnika/ce %1$s u temi:',
3=>'<strong>Odgovor</strong> korisnika/ce %1$s u temi:',
),
...
2=>'<strong>Citiran/a/o</strong> od strane korisnika/ce %1$s u:',
3=>'<strong>Citiran/a/o</strong> od strane korisnika/ce %1$s u:',
),
...
'NOTIFICATION_REPORT_PM_CLOSED'=>'<strong>Prijava privatne poruke zaključena</strong> by %1$s:',
...
'NOTIFICATION_ADMIN_ACTIVATE_USER'=>'<strong>Zahtjev</strong> za <strong>aktivaciju</strong> deaktiviranog/e ili nedavno registriranog/e korisnika/ce: “%1$s”',
...
'NO_EMAIL_MESSAGE'=>'Poruka, za slanje elektroničkom poštom, je prazna.',
'NO_EMAIL_RESPONSE_CODE'=>'Dobivanje odgovora od mail servera nije uspjelo.',
'NO_EMAIL_SUBJECT'=>'Naslov [predmet] poruke, za slanje elektroničkom poštom, nije upisan.',
...
'NO_STYLE_DATA'=>'Nije moguće doći do podataka o stilu/ovima za korisnički stil %s i set za user_id %s.',
'NO_STYLE_CFG'=>'Nije moguće doći do konfiguracijske datoteke stila za: %s.',
...
'POST_UNAPPROVED_EXPLAIN'=>'Post će postati vidljiv ostalim korisnicima/ama tek po odobrenju od strane moderatora/ice.',
...
'REMOVE'=>'Izbriši',
'REMOVE_INSTALL'=>'Izbriši, premjesti ili preimenuj mapu install.<br />Ako ne izbrišeš mapu, samo će [ti] <em>Administriranje foruma [AF]</em> biti dostupno.',
'REPLIES'=>'Odgovori',
...
'ROUTE_NOT_FOUND'=>'Ruta “%s” nije pronađena.',
'ROUTE_INVALID_MISSING_PARAMS'=>'Neispravni odnosno nedostajući parametri “%s” rute.',
'FEED'=>'Feed',
'FEED_NEWS'=>'Novosti',
// <!-- !anečih ej akcoK -->
...
'SEARCH_UNANSWERED'=>'Neodgovorene teme',
...
'SEND_EMAIL_USER'=>'Pošalji poruku elektroničkom poštom korisniku/ci %s',
...
'SORRY_AUTH_READ_TOPIC'=> 'Za pregledavanje ove teme, trebaš biti ovlašten/a.',
'SORRY_AUTH_VIEW_ATTACH'=>'Za preuzimanje ovog privitka, trebaš biti ovlašten/a.',
'SORT_BY'=>'Redanje',
'SORT_DIRECTION'=>'Smjer',
'SORT_JOINED'=>'Datum registracije',
'SORT_LOCATION'=>'Lokacija',
'SORT_OPTIONS'=>'Prikaži (i) opcije redanja',
'SORT_RANK'=>'Status',
'SORT_POSTS'=>'Postovi',
'SORT_TOPIC_TITLE'=>'Naslov teme',
'SORT_USERNAME'=>'Korisničko ime',
'SPLIT_TOPIC'=>'Podijeli temu',
'SQL_ERROR_OCCURRED'=>'Došlo je do sql greške [problema].<br />Ako se problem nastavi, kontaktiraj %sadministratora/icu%s.',
...
'TOO_LARGE'=>'Vrijednost koju si upisao/la je prevelika.',
...
'TOO_SHORT'=>'Vrijednost koju si upisao/la je prekratka.',
...
'TOO_SMALL'=>'Vrijednost koju si upisao/la je premala.',
...
1=>'Ukupno postova: <strong>%d</strong>.',
2=>'Ukupno postova: <strong>%d</strong>.',
3=>'Ukupno postova: <strong>%d</strong>.',
),
...
'URL_REDIRECT'=>'Ako “ti” preglednik ne podržava preusmjeravanje, za preusmjerenje, klikni %sovdje%s.',
...
'WRONG_DATA_COLOUR'=>'Boja vrijednosti koju si upisao/la je neispravna.',
