...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT'				=> 'Text Prima pagină forum',
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Acest text este afișat ca prima pagină a forumului. Dacă nu este specificat, va fi implicit setat ca “Prima pagină”.',
	'BOARD_STYLE'					=> 'Stil forum',
	'CUSTOM_DATEFORMAT'				=> 'Personalizat…',
	'DEFAULT_DATE_FORMAT'			=> 'Format dată',
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Sintaxa utilizează același format ca funcțiile de dată din PHP <a href="https://www.php.net/manual/datetime.format.php">date functions</a>.',
	'DEFAULT_LANGUAGE'				=> 'Limba standard',
	'DEFAULT_STYLE'					=> 'Stil standard',
	'DEFAULT_STYLE_EXPLAIN'			=> 'Stilul standard pentru utilizatorii noi.',
	...
	'DISPLAY_LAST_SUBJECT'			=> 'Afișarea subiectului ultimul mesaj adăugat în lista forumurilor',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Subiectul ultimului mesaj adăugat va fi afișat în lista forumurilor cu o legătură către mesaj. Subiectele din forumurile protejate cu parolă și forumurile în care utilizatorul nu are permisiuni de citire nu vor fi afișate.',
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Afișează mesajele neaprobate autorului',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Mesajele neaprobate pot fi văzute de către autorul subiectului. Nu se aplică postărilor anonime.',
	'GUEST_STYLE'					=> 'Stil vizitatori',
	'GUEST_STYLE_EXPLAIN'			=> 'Stilul forumului pentru vizitatori.',
	...
	'SITE_HOME_TEXT'				=> 'Text index website',
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Acest text va fi afișat ca legătură către pagina de start a website-ului. Dacă nu este specificat, va fi setat implicit “Acasă”.',
	'SITE_HOME_URL'					=> 'URL website',
	'SITE_HOME_URL_EXPLAIN'			=> 'Dacă este specificat, o legătură către acest URL va fi pregătit în ierahia forumului și logo-ul forumului va avea o legătură către acest URL în locul indexului forumului. E necesară o adresă URL absolută, ex. <samp>http://www.phpbb.com</samp>.',
	'SITE_NAME'						=> 'Nume site',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Permite notificările pentru forum',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_GRAVATAR'				=> 'Permite avataruri gravatar',
	'ALLOW_LOCAL'					=> 'Permite galerie avataruri',
	'ALLOW_REMOTE'					=> 'Permite avataruri la distanţă',
	'ALLOW_REMOTE_EXPLAIN'			=> 'Avatarul este localizat pe alt site web.<br><em><strong class="error">Atenție:</strong> Activarea acestei funcții ar putea permite utilizatorilor să verifice existența fișierelor și serviciilor care sunt accesibile doar în rețeaua locală.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Permite încărcarea avatarurilor la distanţă',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Permite încărcarea avatarurilor aflate pe alt site web.<br><em><strong class="error">Atenție:</strong> Activarea acestei funcții ar putea permite utilizatorilor să verifice existența fișierelor și serviciilor care sunt accesibile doar în rețeaua locală.</em>',
	'ALLOW_UPLOAD'					=> 'Permite încărcarea avatarurilor',
	'AVATAR_GALLERY_PATH'			=> 'Cale galerie avatar',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Calea din directorul rădăcină phpBB pentru imagini preîncărcate, de exemplu <samp>images/avatars/gallery</samp>.<br>Punctele duble ca <samp>..</samp> vor fi înlăturate din motive de securitate.',
	'AVATAR_STORAGE_PATH'			=> 'Cale stocare avatar',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Calea din directorul rădăcină phpBB, de exemplu. <samp>images/avatars/upload</samp>.<br>Punctele duble ca <samp>..</samp> vor fi înlăturate din motive de securitate.',
...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'Scheme permise în linkuri',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Utilizatorii pot posta doar URL-uri fără schemă sau unul dintre schemele permise din lista separată prin virgule.',
	...
	'MAX_POST_IMG_HEIGHT'			=> 'Înălţimea maximă a unui fișier flash în mesaj',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> 'Înălţimea maximă a unui fişier flash în posturi. Specificaţi valoarea 0 pentru înalţime nelimitată.',
	'MAX_POST_IMG_WIDTH'			=> 'Lăţimea maximă a unui fișier flash într-un mesaj',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'Lăţimea maximă a unui fişier flash în mesaje. Specificaţi valoarea 0 pentru lăţime nelimitată.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'Aceasta setare determină dacă utilizatorii au acces imediat la forum sau dacă este necesară o confirmare. De asemenea, puteţi dezactiva noile înregistrări. <em>Folosirea funcției de email pe forum trebuie să fie permisă pentru a utiliza activarea de către utilizator sau administrator.</em>',
	'ACC_ACTIVATION_WARNING'		=> 'Vă rugăm să rețineți că metoda de activare selectată necesită activarea email-urilor, în caz contrar înregistrarea va fi dezactivată. Vă recomandăm fie să selectati o metodă diferită de activare sau reactivați email-urile.',
...
//	'ACC_USER_ADMIN'			=> 'Utilizator + administrator',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'Numărul minim de caractere în parolă. Rețineți că numărul maxim nu este limitat.',
...
$lang = array_merge($lang, array(
	...
	'ACP_VC_EXT_GET_MORE'					=> 'Pentru suplimente (posibil mai bune) anti-spam, vizitați <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>Baza de date cu extensii a phpBB.com</strong></a>. Pentru mai multe informații pentru evitarea spam-ului, vizitați <a href="https://www.phpbb.com/go/anti-spam"><strong>Catalogul de articole phpBB.com</strong></a>.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Aceste detalii definesc datele folosite pentru a trimite cookie-urile către browserele utilizatorilor. În majoritatea cazurilor, valorile standard pentru setările cookie ar trebui să fie suficiente. Dacă trebuie să schimbaţi vreuna, aveţi grijă, setările incorecte pot face imposibilă autentificarea utilizatorilor. Dacă aveți probleme cu utilizatori deconectați, vizitați <strong><a href="https://www.phpbb.com/support/go/cookie-settings">phpBB.com Knowledge Base - Fixing incorrect cookie settings</a></strong>.',

	'COOKIE_DOMAIN'				=> 'Domeniu cookie',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'În cele mai multe cazuri, domeniul cookie-ului este opțional. Lăsați-l necompletat dacă nu sunteți sigur.<br><br>În cazul în care aveți un forum integrat cu alte software-uri sau aveți mai multe domenii, pentru a determina domeniul cookie-ului trebuie să urmați acești pași. Dacă aveți ceva de genul <i>example.com</i> și <i>forum.exemplu.com</i>, sau poate <i>forum.exemplu.com</i> și <i>blog.exemplu.com</i>, eliminați subdomeniile până găsiți domeniul comun, <i>exemplu.com</i>. Apoi adăugați un punct în fața domeniului comun și veți introduce .exemplu.com (atenție la punctul de la început).',
	'COOKIE_NAME'				=> 'Nume cookie',
	'COOKIE_NAME_EXPLAIN'		=> 'Acesta poate fi orice doriți, fiți originali. De fiecare dată când setările cookie-ului sunt modificate, numele cookie-ului ar trebui schimbat.',
	'COOKIE_NOTICE'				=> 'Cookie notice',
	'COOKIE_NOTICE_EXPLAIN'		=> 'Dacă este activat, un anunț privind cookie-urile va fi afișat utilizatorilor atunci când vizitează forumul dumneavoastră. Acest lucru ar putea fi necesar conform legislației, în funcție de conținutul forumului și de extensiile activate.',
	'COOKIE_PATH'				=> 'Cale cookie',
	'COOKIE_PATH_EXPLAIN'		=> 'Aceasta va fi, de obicei, aceeași ca și calea scriptului dumneavoastră sau pur și simplu un slash pentru a face cookie-ul accesibil pe întreg domeniul site-ului.',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Aici puteți activa sau dezactiva pagina de contact și să adăugați un text care să fie afișat în această pagină.',

	'CONTACT_US_ENABLE'				=> 'Activează pagina de contact',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Această pagină permite utilizatorilor să trimită email-uri către administratorii forumului. Vă rugăm să rețineți că setarea de a trimite email-uri trebuie să fie activă. Puteți găsi această opțiune în General &gt; Comunicaţii client &gt; Configurări e-mail.',

	'CONTACT_US_INFO'				=> 'Informații de contact',
	'CONTACT_US_INFO_EXPLAIN'		=> 'Acest mesaj este afișat în pagina de contact',
	'CONTACT_US_INFO_PREVIEW'		=> 'Informații pagina de contact - Previzualizare',
	'CONTACT_US_INFO_UPDATED'		=> 'Informațiile din pagina de contact au fost actualizate.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN'						=> 'Permite folosirea conținutului furnizat de rețele terțe părți',
	'ALLOW_CDN_EXPLAIN'				=> 'Dacă această setare este activată, unele fișiere vor fi furnizate de servere externe terțe, în loc de serverul dumneavoastră. Acest lucru reduce lățimea de bandă a rețelei utilizată de serverul dumneavoastră, dar poate prezenta o problemă de confidențialitate în unele țări. Într-o instalare phpBB implicită, aceasta include încărcarea „jQuery” și a fontului „Open Sans” de pe rețeaua de livrare a conținutului Google. Aceasta se aplică și fontului „Font Awesome”, pe care phpBB și unele extensii îl folosesc pentru a afișa iconițele.',
	'ALLOW_LIVE_SEARCHES'			=> 'Permite căutări directe',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Dacă această setare este activată, se furnizează utilizatorilor sugestii de căutare în timp ce tastează în câmpurile forumului.',
	...
	'LOAD_CPF_PM'					=> 'Afişează câmpuri de profil personalizate în mesajele private',
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'Limită de mesaje pentru activitatea utilizatorului',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'Subiectul/forumul activ nu va fi afișat utilizatorilor care au mai mult de acest număr de mesaje. Setați 0 pentru a dezactiva limita.',
	'READ_NOTIFICATION_EXPIRE_DAYS'	=> 'Expirarea notificărilor de citire',
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Numărul de zile care trebuie să treacă înainte ca notificările de citire să fie șterse automat. Setați această valoare la 0 pentru a menține permanent notificările.',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'Activează butonul de mesaje private specific pentru permisiuni pe paginile subiectelor',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'Dacă această setare este activată, doar profilele de mesaje ale utilizatorilor care au permisiunea de a citi mesaje private vor avea un buton pentru mesaje private.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Ambele chei, cheia și cheia secretă pentru fiecare serviciu OAuth activat trebuie furnizate. Doar una a fosr prevăzută de providerul serviciului OAuth.',
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Fiecare furnizor OAuth necesită o cheie secretă și o cheie pentru autentificarea cu servere externe. Acestea ar trebui să fie furnizate se serviciile OAuth la înregistrarea website-ului dumneavoastră și trebuie introduse exact cum au fost furnizate.<br>Orice serviciu care nu are ambele chei introduse aici nu va fi disponibil pentru folosirea utilizatorilor din forum. Rețineți de asemenea că acești utilizatori se pot înregistra și autentifica folosind autentificarea DB.',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Cheie',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Cheie secretă',

	'APACHE_SETUP_BEFORE_USE'	=> 'Trebuie să configuraţi autentificarea Apache înainte să folosiţi phpBB cu această metodă. Reţineţi că numele de utilizator pe care-l folosiţi pentru autentificarea Apache trebuie să fie acelaşi cu numele propriu de utilizator phpBB. Autentificarea Apache poate fi folosită doar cu mod_php (nu cu o versiune CGI).',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE'		=> 'Activați rescrierea URL-ului',
	'MOD_REWRITE_ENABLE_EXPLAIN' => 'Când este activată, URL-urile care conțin ’app.php’ va fi rescris pentru a elimina numele fișierului (ex. app.php/foo va deveni /foo). <strong>Modulul mod_rewrite trebuie activat în setările serverului Apache pentru ca această setare să funcționeze; dacă această opțiune este activată fără activarea mod_rewrite, URL-urile forumului pot fi nefuncționale.</strong>',
	'MOD_REWRITE_DISABLED'		=> 'Modulul <strong>mod_rewrite</strong> din serverul Apache este dezactivat. Activați modulul sau contactați providerul unde gazduiți site-ul web dacă doriți activarea acestei facilități.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Nu se poate determină dacă acest server suportă rescrierea adreselor URL. Această setare poate fi activată dar dacă rescrierea URL nu e disponilă, căile generate de forum (cum ar fi cele utilizate pentru legături) pot fi nefuncționale. Contactați firma unde găzduiți forumul dacă nu sunteți sigur dacă e sigură activarea acestei funcționalități.',
	...
	'SERVER_NAME_EXPLAIN'		=> 'Numele domeniului de unde rulează acest forum (de exemplu: <samp>exemplu.com</samp>).',
	...
	'USE_SYSTEM_CRON'			=> 'Rularea sarcinilor periodice din cron-ul sistemului de operare',
	'USE_SYSTEM_CRON_EXPLAIN'	=> 'Dacă este dezactivată, phpBB va asigura automat rularea periodică a sarcinilor. Dacă este activată, phpBB nu va asigura automat rularea periodică a sarcinilor; un administrator de sistem trebuie să configureze rularea comenzii <code>bin/phpbbcli.php cron:run</code> de către mecanismul cron al sistemului de operare la intervale regulate (de exemplu, la fiecare 5 minute).',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET'			=> 'Permite resetarea parolei ("Am uitat parola")',
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Determină dacă utilizatorii sunt în măsură să utilizeze legătura "Am uitat parola" în pagina de autentificare pentru a-și reseta parola. Dacă utilizați un mecanism de autentificare extern, ar trebui să dezactivați această facilitate.',
	...
	'REFERRER_VALID'				=> 'Validează Referer-ul',
	'REFERRER_VALID_EXPLAIN'		=> 'Dacă este activată, referer-ul cererilor POST vor fi verificate cu setările căii pentru server/script. Aceasta poate cauza probleme cu forumuri ce folosesc mai multe domenii şi sau autentificări externe.',
	...
	'UPLOAD_CERT_VALID'				=> 'Validează certificatul de încărcare',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Dacă este activat, certificatele pentru încărcările de la distanță vor fi validate. Aceasta necesită ca pachetul CA să fie definit prin setarea <samp>openssl.cafile</samp> sau <samp>curl.cainfo</samp> în fișierul dumneavoastră php.ini.',
));
...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL'					=> 'Adresa de e-mail expeditor',
	'ADMIN_EMAIL_EXPLAIN'			=> 'Aceasta va fi folosită ca şi adresa de expeditor pentru toate mesajele electronice, adresa e-mail a contactului tehnic. Va fi folosită întotdeauna ca fiind <samp>trimis de</samp> în e-mail-uri.',
	...
	'CONTACT_EMAIL_NAME'			=> 'Nume contact',
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Acesta este numele pe care destinatarii email-ului il vor vedea. Dacă nu doriți să aveți un nume de contact, lăsați gol acest câmp.',
	'EMAIL_FORCE_SENDER'			=> 'Forțează adresa de expeditor',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Aceasta va seta <samp>Return-Path</samp> la adresa de e-mail de expeditor în loc să utilizeze utilizatorul local și numele gazdei serverului. Această setare nu se aplică atunci când se utilizează SMTP.<br><em><strong>Atenție:</strong> Necesită ca utilizatorul sub care rulează serverul web să fie adăugat ca utilizator de încredere în configurația sendmail.</em>',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'Numărul maxim de destinatari permis',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Dacă este necesar, setați această valoare astfel încât să nu depășească numărul maxim de destinatari pe care serverul dumneavoastră de e-mail îl permite într-un singur mesaj.',
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Dacă această opţiune este dezactivată, niciun email nu va fi trimis de forum. <em>Reţineţi că setările de activare ale contului de utilizator şi administrator impun ca această setare să fie activată. Dacă se foloseşte activarea de către „Utilizator” sau „Administrator”, dezactivarea acestei setări va dezactiva înregistrarea.</em>',
	'SEND_TEST_EMAIL'				=> 'Trimite un e-mail de test',
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Aceasta va trimite un e-mail de test la adresa definită în contul dumneavoastră.',
	'SMTP_ALLOW_SELF_SIGNED'		=> 'Permite certificate SSL auto-semante',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Permite conexiunile la serverul SMTP cu certificat SSL auto-semnat. <br><em><strong>Atenție:</strong> Permiterea certificatelor SSL auto-semante poate avea implicații de securitate.</em>',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Nu specificați un protocol (<samp>ssl://</samp> sau <samp>tls://</samp>) decât dacă furnizorul de e-mail vă cere acest lucru.',
	...
	'SMTP_VERIFY_PEER'				=> 'Verifică certificatul SSL',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Cere verificarea certificatului SSL utilizat de serverul SMTP. <br><em><strong>Atenție:</strong> Conectarea la parteneri cu certificate SSL neverificate poate avea implicații de securitate.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Verifică numele partenerului SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Cere verificarea numelui partenerului pentru serverele SMTP care utilizează conexiuni SSL/TSL. <br><em><strong>Atenție:</strong> Conectarea la parteneri cu certificate SSL neverificate poate avea implicații de securitate.</em>',
	'TEST_EMAIL_SENT'				=> 'E-mailul de test a fost trimis.<br>Dacă nu îl primiți, vă rugăm să verificați configurația e-mailurilor dumneavoastră.<br><br>Dacă aveți nevoie de asistență, vă rugăm să vizitați <a href="https://www.phpbb.com/community/">forumurile de suport phpBB</a>.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> 'Permite certificate SSL auto-semante',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Permite conexiunile la serverul SMTP cu certificat SSL auto-semnat. <br><em><strong>Atenție:</strong> Permiterea certificatelor SSL auto-semante poate avea implicații de securitate.</em>',
	...
	'JAB_VERIFY_PEER'				=> 'Verifică certificatul SSL',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Cere verificarea certificatului SSL utilizat de serverul Jabber. <br><em><strong>Atenție:</strong> Conectarea la parteneri cu certificate SSL neverificate poate avea implicații de securitate.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Verifică numele partenerului Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Cere verificarea numelui partenerului pentru serverele Jabber care utilizează conexiuni <br><em><strong>Atenție:</strong> Conectarea la parteneri cu certificate SSL neverificate poate avea implicații de securitate.</em>',
));
