...
$lang = array_merge($lang, array(
	...
	'ACP_RESTORE_EXPLAIN'	=> 'Naredili boste popolno obnovitev vseh phpBB tabel iz shranjene datoteke. Če veš server podpira gzip ali bzip2 stiskanje lahko uporabite tudi stisnjeno datoteko, saj se bo le-ta avtomatsko razširila.<strong>OPOZORILO:</strong> To bo prepisalo vse obstoječe podatke. Obnovitev lahko traja kar nekaj časa, zato ostanite na tej strani dokler se proces ne zaključi. Varnostne kopije so shranjene v <samp>store/</samp> direktoriju. Za njih se domneva, da so bile generirane s pomočjo pbpBB funkcije za varnostne kopije. Obnovitve varnostnih kopij , ki niso bile ustvarjene s to funkcijo lahko dela ali ne.',
	...
	'BACKUP_NOT_SUPPORTED'	=> 'Izbrana varnostna kopija ni podprta',
