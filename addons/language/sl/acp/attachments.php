...
$lang = array_merge($lang, array(
	...
	'ATTACH_POST_TYPE'					=> 'Tip sporočila',
	...
	'FILES_GONE'			=> 'Nekatere priponke, ki so označene za izbris ne obstajajo. Morda so bile že izbrisane. Obstoječe priponke so bile izbrisane.',
	'FILES_STATS_WRONG'		=> 'Vaša statistika datotek je lahko nenatančna in jo je potrebno sinhronizirati. Dejanske vrednosti: Število priponk = %1$d, skupna velikost priponk = %2$s.<br />Kliknite %3$stukaj%4$s da jih sinhronizirate.',
	...
	'IMAGE_QUALITY'				=> 'Kakovost naloženih slikovnih prilog (samo JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Določite vrednost med 50% (manjša velikost datoteke) in 90% (višja kakovost). Kakovost višja od 90% poveča velikost datotek in je onemogočena. Nastavitev velja le, če so največje dimenzije slike nastavljene na vrednost, ki ni 0px x 0px.',
	'IMAGE_STRIP_METADATA'		=> 'Metapodatki o slikovnih vrsticah (samo JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Exif metapodatki, npr. ime avtorja, GPS koordinate in podrobnosti fotoaparata. Nastavitev velja le, če so največje dimenzije slike nastavljene na vrednost, ki ni 0px x 0px.',
	...
	'NO_ATTACHMENTS'			=> 'Za to obdobje ni najdenih priponk.',
	'NO_EXT_GROUP'				=> 'Brez',
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Za zasebna sporočila ni <a href="%s">dovoljenih skupin razširitev</a>.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Za objave ni <a href="%s">dovoljenih skupin razširitev</a>.',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Ste prepričani, da želite ponovno osvežiti statistike datotek?',
	...
	'UPLOAD_POST_NOT_EXIST'			=> 'Datoteke “%1$s” ni mogoče naložiti v objavo številka %2$d, ker objava ne obstaja.',
));
