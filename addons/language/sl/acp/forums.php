...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'Frekvenca zmanjševanja senčenja',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'Obdobje zmanjševanja senčenja',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Število dni po izbrisu izbrane teme.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Čas in dnevi med zmanjševanjem dogodkov.',
	...
	'FORUM_LINK_EXPLAIN'				=> 'Polni URL (vključno s protokolom, npr.: <samp>http://</samp>) na lokacijo, kamor bo izbira tega foruma prenesla uporabnika, npr.: <samp>http://www.phpbb.com/</samp>.',
	...
	'FORUM_NAME_EMOJI'					=> 'Ime foruma, ki ste ga vnesli, je neveljavno. <br> Vsebuje naslednje nepodprte znake:<br>%s',
	...
	'FORUM_PRUNE_SHADOW'				=> 'Onemogočite zmanjševanje senčenja teme',
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> 'Zmanjšajte forum teme, spodaj nastavite frekvenco/obdobje parametra.',
	'FORUM_RESYNCED'					=> 'Forum â€ś%sâ€ť uspešno usklajen',
	...
	'LINK'						=> 'Povezava',
	'LIMIT_SUBFORUMS'			=> 'Omejite legendo na usmerjanje otroških podforumov',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Omeji podforume za prikazovanje podforumov, ki so neposredni potomci (otroci) trenutnega foruma. Če to onemogočite, bodo prikazani vsi podforume z omogočeno možnostjo »Seznam podforumov v legendi«, ne glede na globino.',
	'LIST_INDEX'				=> 'Prikaži podforum v legendi glavnega foruma',
	'LIST_INDEX_EXPLAIN'		=> 'Prikaže ta forum v kazalu in drugje kot povezavo znotraj legende glavnega foruma, če je možnost glavnega foruma â€śPrikaži podforume v legendiâ€ť omogočena.',
	'LIST_SUBFORUMS'			=> 'Prikaži podforume v legendi',
	'LIST_SUBFORUMS_EXPLAIN'	=> 'Prikaže podforume tega foruma v kazalu in drugje kot povezavo znotraj legende glavnega foruma, če je možnost glavnega foruma â€śPrikaži podforume v legendi glavnega forumaâ€ť omogočena.',
	'LOCKED'					=> 'Zaklenjeno',
