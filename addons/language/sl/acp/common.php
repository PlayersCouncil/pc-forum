...
$lang = array_merge($lang, array(
	...
	'ACP_CONTACT'				=> 'Stran s kontakti',
	'ACP_CONTACT_SETTINGS'		=> 'Nastavitve strani s kontakti',
	...
	'ACP_EXTENSION_MANAGEMENT'	=> 'Upravljanje z dodatki',
	'ACP_EXTENSIONS'			=> 'Upravljaj z dodatki',
	...
	'ACP_GROUPS_POSITION'			=> 'Upravljanje pozicije skupine',

	'ACP_HELP_PHPBB'			=> 'Pomagajte podpreti phpBB',
	...
	'ACP_MANAGE_ATTACHMENTS'			=> 'Upravljaj priponke',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Tukaj lahko naštejete in brišete datoteke pripete prispevkom in zasebnim sporočilom.',
	...
	'ACP_STYLES'				=> 'Slogi',
	'ACP_STYLES_CACHE'			=> 'Počisti cache',
	'ACP_STYLES_INSTALL'		=> 'Namesti sloge',
	...
	'CONTAINER_EXCEPTION' => 'phpBB je naletel na napako gradnje zaradi nameščene razširitve. Zato so vse razširitve začasno onemogočene. Poskusite očistiti predpomnilnik foruma. Vse razširitve bodo samodejno ponovno omogočene, ko bo težava rešena. Če se ta napaka ponavlja, obiščite <a href="https://www.phpbb.com/support">phpBB.com</a> za podporo.',
	'EXCEPTION' => 'Izjema',

	'COLOUR_SWATCH'			=> 'Vzorec barve',
	'CONFIG_UPDATED'		=> 'Konfiguracija uspešno posodobljena.',
	'CRON_LOCK_ERROR'		=> 'Ne morem pridobiti cron ključvanico.',
	'CRON_NO_SUCH_TASK'		=> 'Ne morem najdit cron opravila “%s”.',
	'CRON_NO_TASK'			=> 'Ni potrebnih cron opravil, da potekajo prav zdaj.',
	'CRON_NO_TASKS'			=> 'Ni mogoče najdit cron opravil.',
	'CSV_INVALID'			=> 'Navedena nastavitev, ločena z vejico “%1$s” je neveljavna. Vrednosti naj bodo ločene samo z vejico, ne smejo vsebovati nobenih začetnih ali končnih ločil.',
	...
	'LOAD_NOTIFICATIONS'			=> 'Prikaži obvestila',
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> 'Prikaži seznam obestil na vsaki strani (običajno v glavi).',
	...
	'NO_FILES_TO_DELETE'	=> 'Priponke, ki jih želite izbrisati, ne obstajajo.',
	...
	'RELEASE_ANNOUNCEMENT'		=> 'Najava',
	'REMIND'							=> 'Opomni',
	'REPARSE_LOCK_ERROR'				=> 'Razčlenjevanje je že v teku v drugem procesu.',
	'RESYNC'							=> 'Ponovno uskladi',

	'RUNNING_TASK'			=> 'Trenutna opravila: %s.',
	...
	'TASKS_NOT_READY'			=> 'Nepotrjena opravila:',
	'TASKS_READY'			=> 'Potrjena opravila:',
	'TOTAL_SIZE'			=> 'Skupna velikost',

	'UCP'					=> 'Uporabniška nadzorna plošča',
	'URL_INVALID'			=> 'Navedeni URL za nastavitev “%1$s” je neveljaven.',
	'URL_SCHEME_INVALID'	=> 'Navedena shema “%2$s”, z vejico ločena v nastavitvi “%1$s” ni veljavna. Shema se mora začeti z latinico, ki ji sledijo alfanumerični znaki, vezaji ali pike.',
	'USERNAMES_EXPLAIN'		=> 'Vsako uporabniško ime napiši v drugo vrstico.',
	'USER_CONTROL_PANEL'	=> 'Uporabniška nadzorna plošča',

	'UPDATE_NEEDED'			=> 'Forum ni posodobljen.',
	'UPDATE_NOT_NEEDED'		=> 'Forum je posodobljen.',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD'					=> 'Funkcija za preobremenitev je nepravilno nastavljena',
	'ERROR_MBSTRING_FUNC_OVERLOAD_EXPLAIN'			=> '<var>mbstring.func_overload</var> mora biti nastavljena na 0 ali 4. Trenutno vrednost lahko preverite  na <samp>PHP information</samp> strani.',
	'ERROR_MBSTRING_ENCODING_TRANSLATION'			=> 'Prosojnost znaka je nepravilno nastavljena',
	'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'	=> '<var>mbstring.encoding_translation</var> mora biti nastavljeno na 0. Trenutno vrednost lahko preverite  na <samp>PHP information</samp> strani.',
	'ERROR_MBSTRING_HTTP_INPUT'						=> 'HTTP pretvorba vhodnih znakov mora biti pravilno nastavljena',
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> mora biti prazen. Trenutno vrednost lahko preverite  na <samp>PHP information</samp> strani.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP pretvorba izhodnih znakov mora biti pravilno nastavljena',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> mora biti prazen. Trenutno vrednost lahko preverite  na <samp>PHP information</samp> strani.',
	'ERROR_DEFAULT_CHARSET'							=> 'Privzeti nabor znakov ni pravilno konfiguriran',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> '<var>default_charset</var> mora biti nastavljen na <samp>UTF-8</samp>. Trenutno vrednost lahko preverite na strani <samp>PHP information</samp>.',
	...
	'NO_SEARCH_INDEX'	=> 'Izbrano iskanje ozadja ne vsebuje iskalnega indeksa.<br />Prosimo ustvarite indeks za "%1$s" v %2$s iskalni indeks %3$s sekciji.',
	...
	'PHP_VERSION_OLD'	=> 'Verzija PHPja na strežniku (%1$s) ne bo več dolgo podprta v naslednjih verzijah phpBB. Najnižja zahtevana verzija bo %2$s. %sPodrobnosti%s',
	...
	'PURGE_CACHE_SUCCESS'	=> 'Cache uspešno počiščen.',
	...
	'RESET_ONLINE_SUCCESS'				=> 'Resetiranje rekordnega števila aktivnih uporabnikov',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Ponovna sinhronizacija števila prispevkov',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Ponovna sinhronizacija prekinjenih tem',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Ponovno sinhronizacija statistike',
	'RUN'							=> 'Zaženi sedaj',

	'STATISTIC'					=> 'Statistika',
	'STATISTIC_RESYNC_OPTIONS'	=> 'Ponovno uskladi ali resetiraj statistiko',

	'TIMEZONE_INVALID'	=> 'Časoni pas, ki ste ga izbrali, je neveljaven.',
	'TIMEZONE_SELECTED'	=> '(trenutno izbrano)',
	...
	'VALUE'						=> 'Vrednost',
	'VERSIONCHECK_FAIL'			=> 'Napaka pri pridobitvi podatkov o zadnji različici.',
	'VERSIONCHECK_FORCE_UPDATE'	=> 'Ponovno preveri za novo verzijo',
	'VERSION_CHECK'				=> 'Preverjanje verzije',
	'VERSION_CHECK_EXPLAIN'		=> 'Preverite, ali je vaša phpBB namestitev posodobljena.',
	'VERSIONCHECK_INVALID_ENTRY'	=> 'Najnovejše informacije o različici vsebujejo nepodprte podatke.',
	'VERSIONCHECK_INVALID_URL'		=> 'Najnovejše informacije o različici vsebujejo neveljaven URL.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'Najnovejše informacije o različici vsebujejo neveljavno različico.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Vaša phpBB namestitev ni posodobljena.<br />Spodaj je povezava do napovedane izdaje, ki vsebuje več informacij kot tudi navodila za posodobitev.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Vaša phpBB namestitev ni posodobljena.',
	'VERSION_UP_TO_DATE_ACP'	=> 'Vaša phpBB namestitev je posodobljena. Trenutno ni nobenih posodobitev na voljo.',
...
$lang = array_merge($lang, array(
	...
	'SEND_STATISTICS_LONG'		=> 'Pošlji statistične podatke',
	'SHOW_STATISTICS'			=> 'Pokaži podrobnosti',
	'THANKS_SEND_STATISTICS'	=> 'Hvala za poslane informacije.',
	'FAIL_SEND_STATISTICS'		=> 'phpBB ni uspel poslati statičničnih podatkov',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'			=> '<strong>Dodan ali urejen uporabniški dostop foruma</strong> do %1$s<br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'			=> '<strong>Dodan ali urejen uporabniški dostop moderatorjem foruma</strong> do %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>Dodan ali urejen skupinski dostop foruma</strong> do %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>Dodan ali urejen dostop skupini moderatorjev foruma</strong> do %1$s<br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Dodani ali urejeni moderatorji</strong> za %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Dodane ali urejene pravice foruma</strong> %1$s<br />» %2$s',
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>Napaka pri konfiguriranju BBCode</strong>: %1$s<br />» %2$s',
	...
	'LOG_CONFIG_FEED'			=> '<strong>Spremenjeni viri RSS nastavitev</strong>',
	...
	'LOG_DELETE_POST'			=> '<strong>Izbrisano sporočilo “%1$s”, ki ga je napisal “%2$s” z naslednjim vzrokom </strong><br />» %3$s',
	'LOG_DELETE_SHADOW_TOPIC'	=> '<strong>Izbriši sled teme</strong><br />» %s',
	'LOG_DELETE_TOPIC'			=> '<strong>Izbrisana tema “%1$s”, ki jo je napisal "%2$s" z naslednjim vzrokom</strong><br />» %3$s',
	...
	'LOG_MOVED_TOPIC'			=> '<strong>Prestavljena tema</strong><br />» %s',
	...
	'LOG_POST_DISAPPROVED'		=> '<strong>Neodobreno sporočilo “%1$s” uporabnika “%3$s” zaradi</strong><br />» %2$s',
	'LOG_POST_EDITED'			=> '<strong>Urejeno sporočilo “%1$s”, uporabnika “%2$s” zaradi</strong><br />» %3$s',
	'LOG_POST_RESTORED'			=> '<strong>Obnovljen prispevek</strong><br />» %s',
	'LOG_REPORT_CLOSED'			=> '<strong>Zaprto poročilo</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Izbrisano poročilo</strong><br />» %s',
	'LOG_RESTORE_TOPIC'			=> '<strong>Obnovljena tema “%1$s” avtorja</strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'		=> '<strong>Mehko brisan prispevek “%1$s” avtorja “%2$s” zaradi sledečega razloga</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'		=> '<strong>Mehko brisana tema “%1$s” avtorja “%2$s” zaradi sledečega razloga</strong><br />» %3$s',
	...
	'LOG_TOPIC_RESTORED'		=> '<strong>Obnovljena tema</strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Neodobrena tema “%1$s”, uporabnika “%3$s” zaradi</strong><br />» %2$s',
	...
	'LOG_ERROR_CAPTCHA'		=> '<strong>CAPTCHA napaka</strong><br />» %s',
	...
	'LOG_GENERAL_ERROR'	=> '<strong>Prišlo je do napake</strong>: %1$s <br />» %2$s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED'		=> '<strong>Ne morem odpreti %1$s za čiščenje, preverite dovoljenja.</strong><br />Izjema: %2$s<br />Sledenje: %3$s',
	...
	'LOG_PRUNE_SHADOW'		=> '<strong>Avtomatsko obrezane senčne teme</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Statistika datotek ponovno sinhronizirana</strong>',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Sphinx napaka</strong><br />» %s',

	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> 'Spamhaus ne dovoljuje poizvedb z uporabo odprtega razreševalnika. Preverjanje črnega seznama je onemogočeno. Za več informacij obiščite https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> 'Omejitev števila poizvedb Spamhaus je bila presežena. Preverjanje črnega seznama je onemogočeno. Za več informacij obiščite https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	...
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>Odstranjeno opozorilo uporabnika</strong><br />» %1$s',
		2 => '<strong>Odstranjeni %2$d opozorili uporabnika</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
		3 => '<strong>Odstranjena %2$d opozorila uporabnika</strong><br />» %1$s',
		4 => '<strong>Odstranjenih %2$d opozoril uporabnika</strong><br />» %1$s',
	),
	...
	'LOG_EXT_ENABLE'	=> '<strong>Razširitev omogočena</strong><br />» %s',
	'LOG_EXT_DISABLE'	=> '<strong>Razširitev onemogočena</strong><br />» %s',
	'LOG_EXT_PURGE'		=> '<strong>Izbrisani podatki razširitve</strong><br />» %s',
	'LOG_EXT_UPDATE'	=> '<strong>Razširitev posodobljena</strong><br />» %s',
));
