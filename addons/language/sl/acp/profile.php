...
$lang = array_merge($lang, array(
	...
	'ALPHA_DOTS'			=> 'Alfanumerično in pike (obdobje)',
	'ALPHA_ONLY'			=> 'Samo alfanumerični znaki',
	'ALPHA_SPACERS'			=> 'Alfanumerični znaki in presledki',
	'ALPHA_UNDERSCORE'		=> 'Alfanumerično in podčrtano',
	'ALPHA_PUNCTUATION'		=> 'Alfanumerično z vejico, pikami, podčrtano in pomišljajem. Začetek s črko',
	...
	'DISPLAY_ON_MEMBERLIST'			=> 'Prikaz na seznamu članov',
	'DISPLAY_ON_MEMBERLIST_EXPLAIN'	=> 'Če je ta možnost omogočena, se bo polje prikazalo v vrsti uporabnikov na zaslonu seznama članov.',
	'DISPLAY_ON_PM'					=> 'Prikaži na zaslonu zasebnih sporočil',
	'DISPLAY_ON_PM_EXPLAIN'			=> 'Če je ta možnost omogočena, bo polje prikazano na mini-profilu na zaslonu zasebnih sporočil.',
	...
	'FIELD_CONTACT_DESC'		=> 'Opis stika',
	'FIELD_CONTACT_URL'			=> 'Povezava stika',
	'FIELD_DATE'				=> 'Datum',
	...
	'FIELD_INT'					=> 'Števila',
	'FIELD_IS_CONTACT'			=> 'Prikaži polje kot kontaktno polje',
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Kontaktno polje je prikazano v oddelku za stike z uporabniškim profilom ter je prikazano drugače v mini profilu zraven prispevkov in zasebnih sporočil. Lahko uporabite <samp>%s</samp> kot mesto rezervirano za spremenljivko, ki bo nadomeščena z vrednostjo , ki jo vnese uporabnik.',
	...
	'LETTER_NUM_DOTS'			=> 'Vse črke, številke in pike (obdobje)',
	'LETTER_NUM_ONLY'			=> 'Vse črke in številke',
	'LETTER_NUM_PUNCTUATION'	=> 'Vse črke, številke, vejica, pike, podčrtavanje in pomišljaji začeti z vsako črko',
	'LETTER_NUM_SPACERS'		=> 'Vse črke, številke in presledki',
	'LETTER_NUM_UNDERSCORE'		=> 'Vse črke, številke in podčrtavanje',
