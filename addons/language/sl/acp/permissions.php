...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Za nadalnje informacije o nastavitvah in urejaju dovoljenj na vašem phpBB3 forumu, prosim poglejte <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">Chapter 1.5 of our Quick Start Guide</a>.</p>
	',

	'ACL_NEVER'				=> 'Nikoli',
	'ACL_SET'				=> 'Nastavitve dovoljenj',
	'ACL_SET_EXPLAIN'		=> 'Dovoljenja so osnovana po principu <strong>DA</strong>/<strong>NE</strong>. Izbira <strong>NIKOLI</strong> za uporabnika ali skupino uporabnikov velja več kot katero koli drugo dovoljenje. Če ne želite dodeliti posameznega dovoljenja uporabniku oz. skupini, potem izberite možnost <strong>NE</strong>. Če so dovoljenja nastavljena že kje drugje, potem bodo obveljala, drugače pa bo obveljala nastavitev <strong>NE</strong>. Z pomočjo označitve polj (z kljukico) lahko nastavite dovoljenj, ampak manj natančno. Upoštevajte, da nastavitev skrbniških dovoljenj za račune ustanoviteljev nima nobenega učinka, saj so skrbniška dovoljenja za ustanovitelje vedno nastavljena na <strong>DA</strong>.',
	...
	'ALL_NEVER'					=> 'Vse <strong>NIKOLI</strong>',
	'ALL_NO'					=> 'Vse <strong>NE</strong>',
	'ALL_USERS'					=> 'Izberi vse uporabnike',
	'ALL_YES'					=> 'Vse <strong>DA</strong>',
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'Nastavitve do te vloge ne spremijo dovoljenj na desni. Če želite ponastaviti ali izbrisati vsa dovoljenja uporabite možnost “Vse <strong>NE</strong>”.',
	...
	'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'		=> 'Vloga članov novo registriranih uporabnikov; ne vsebuje <strong>NIKOLI</strong> dovoljenj za zaklepanje funkcij za nove uporabnike.',
	...
	'ROLE_DESCRIPTION_USER_NEW_MEMBER'		=> 'Vloga članov novo registriranih uporabnikov; ne vsebuje <strong>NIKOLI</strong> dovoljenj za zaklepanje funkcij za nove uporabnike.',
	...
	'TRACE_DEFAULT'					=> 'Privzeto je vsako dovoljenje <strong>NE</strong> (nenastavljeno). Druge nastavitve lahko prepišejo ta dovoljenja.',
	'TRACE_FOR'						=> 'Slediti za',
	'TRACE_GLOBAL_SETTING'			=> '%s (splošno)',
	'TRACE_GROUP_NEVER_TOTAL_NEVER'	=> 'Dovoljenje te skupine je nastavljeno na <strong>NIKOLI</strong>, kot skupni rezultat skupna nastavitev, tako da je nov rezultat ohranjen.',
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Dovoljenje te skupine, za ta forum, je nastavljeno na <strong>NIKOLI</strong> kot skupna nastavitev, tako da je nov rezultat ohranjen.',
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'Dovoljenje te skupine je nastavljeno na <strong>NIKOLI</strong>, katero postane nova splošna nastavitev, ker še ni bila nastavljena (nastavljena na <strong>NE</strong>).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Dovoljenje te skupine, za ta forum, je nastavljeno na <strong>NIKOLI</strong>, katero, postane nova splošna nastavitev, ker še ni bila nastavljena (nastavljena na <strong>NE</strong>).',
	'TRACE_GROUP_NEVER_TOTAL_YES'	=> 'Dovoljenje te skupine je nastavljeno na <strong>NIKOLI</strong>, katero prepiše splošne nastavitve tega uporabnika iz <strong>DA</strong> na <strong>NIKOLI</strong>.',
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Dovoljenje te skupine za ta forum je nastavljeno na <strong>NIKOLI</strong>, katero prepiše splošne nastavitve tega uporabnika iz <strong>DA</strong> na <strong>NIKOLI</strong>.',
	'TRACE_GROUP_NO'				=> 'Dovoljenje <strong>NE</strong>, za to skupino, tako da je stara nastavitev ohranjena.',
	'TRACE_GROUP_NO_LOCAL'			=> 'Dovoljenje <strong>NE</strong>, za to skupino, znotraj tega foruma, tako da je stara nastavitev ohranjena.',
	'TRACE_GROUP_YES_TOTAL_NEVER'	=> 'Dovoljenje te skupine je nastavljeno na <strong>DA</strong>, ampak splošni <strong>NIKOLI</strong> ne more biti prepisan.',
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'Dovoljenje te skupine, za ta forum, je nastavljeno na <strong>DA</strong>, ampak splošni <strong>NIKOLI</strong> ne more biti prepisan.',
	'TRACE_GROUP_YES_TOTAL_NO'		=> 'Dovoljenje te skupine je nastavljeno na <strong>DA</strong>, katero postane nova nastavitev, ker še ni bila nastavljena. (nastavljena na <strong>NE</strong>).',
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Dovoljenje te skupine, za ta forum, je nastavljeno na <strong>DA</strong>, katero postane nova nastavitev, ker še ni bila nastavljena. (nastavljena na <strong>NE</strong>).',
	'TRACE_GROUP_YES_TOTAL_YES'		=> 'Dovoljenje te skupine je nastavljeno na <strong>DA</strong>, in skupno dovoljenje je že nastavljeno na <strong>DA</strong>, tako da je skupen rezultat ohranjen.',
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Dovoljenje te skupine, za ta forum, je nastavljeno na <strong>DA</strong>, in skupno dovoljenje je že nastavljeno na <strong>DA</strong>, tako da je skupni rezultat ohranjen.',
	'TRACE_PERMISSION'				=> 'Sledi dovoljenju - %s',
	'TRACE_RESULT'					=> 'Sledi rezultatu',
	'TRACE_SETTING'					=> 'Sledi nastavitvi',

	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'Neodvisno uporabniško dovoljenje foruma se sklicuje na <strong>DA</strong>, ampak skupno dovoljenje je že nastavljeno na <strong>DA</strong>, tako da je skupni razultat ohranjen. %sSledi splošna dovoljenja%s',
	'TRACE_USER_GLOBAL_YES_TOTAL_NEVER'		=> 'Neodvisno uporabniško dovoljenje foruma se sklicujeo <strong>DA</strong>, prepiše trenutni lokalni rezultat <strong>NIKOLI</strong>. %sSledi splošna dovoljenja%s',
	'TRACE_USER_GLOBAL_NEVER_TOTAL_KEPT'	=> 'Neodvisno uporabniško dovoljenje foruma se sklicuje <strong>NIKOLI</strong>, ne vpliva pa na lokalno nastavitev. %sSledi splošna dovoljenja%s',

	'TRACE_USER_FOUNDER'					=> 'Uporabnik ima nastavitve ustanovitelja, zato so administrativna dovoljenja privzeto nastavljena na <strong>DA</strong>.',
	'TRACE_USER_KEPT'						=> 'Uporabniško dovoljenje je <strong>NE</strong>, tako da je skupna vrednnost ohranjena.',
	'TRACE_USER_KEPT_LOCAL'					=> 'Uporabniško dovoljenje, za ta forum, je <strong>NE</strong>, tako da je skupna vrednost ohranjena.',
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'Uporabniško dovoljenje je nastavljeno na <strong>NIKOLI</strong> in skupna vrednost na <strong>NIKOLI</strong>, tako da ni nič spremenjeno.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'Uporabniško dovoljenje, za ta forum, je nastavljeno na <strong>NIKOLI</strong> in skupna vrednost na <strong>NIKOLI</strong>, tako da ni nič spremenjeno.',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'Uporabniško dovoljenje je nastavljeno na <strong>NIKOLI</strong>, postane pa skupna vrednost, ker je bila nastavljena na NE.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'Uporabniško dovoljenje, za ta forum, je nastavljeno na <strong>NIKOLI</strong>, postane pa skupna vrednost, ker je bila nastavljena na NE.',
	'TRACE_USER_NEVER_TOTAL_YES'			=> 'Uporabniško dovoljenje je nastavljeno na <strong>NE</strong>, in prepiše vse prejšnje <strong>DA</strong>.',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'Uporabniško dovoljenje, za ta forum, je nastavljeno na <strong>NE</strong>, in prepiše vse prejšnje <strong>DA</strong>.',
	'TRACE_USER_NO_TOTAL_NO'				=> 'Uporabniško dovoljenje je <strong>NE</strong> in skupna vrendost je bila nastavljena na NE, tako da je privzeta na <strong>NIKOLI</strong>.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'Uporabniško dovoljenje, za ta forum, je <strong>NE</strong> in skupna vrendost je bila nastavljena na NE, tako da je privzeta na <strong>NIKOLI</strong>.',
	'TRACE_USER_YES_TOTAL_NEVER'			=> 'Uporabniško dovoljenje je nastavljeno na <strong>DA</strong>, ampak skupni <strong>NIKOLI</strong> ne more biti prepisan.',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'Uporabniško dovoljenje, za ta forum, je nastavljeno na <strong>DA</strong>, ampak skupni <strong>NIKOLI</strong> ne more biti prepisan.',
	'TRACE_USER_YES_TOTAL_NO'				=> 'Uporabniško dovoljenjeje nastavljeno na <strong>DA</strong>, postane pa skupna vrednost, ker je bilo nastavljeno na <strong>NE</strong>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'Uporabniško dovoljenje, za ta forum, je nastavljeno na <strong>DA</strong>, postane pa skupna vrednost, ker je bilo nastavljeno na <strong>NE</strong>.',
	'TRACE_USER_YES_TOTAL_YES'				=> 'Uporabniško dovoljenje je nastavljeno na <strong>DA</strong> in skupna vrednost na <strong>DA</strong>, tako da ni nič spremenjeno.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'Uporabniško dovoljenje, za ta forum, je nastavljeno na <strong>DA</strong> in skupna vrednost na <strong>DA</strong>, tako da ni nič spremenjeno.',
	'TRACE_WHO'								=> 'Koga',
	'TRACE_TOTAL'							=> 'Skupaj',
