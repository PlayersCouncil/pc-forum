...
$lang = array_merge($lang, [
	...
	'CC_SENDER'				=> 'Siųsti man šio pranešimo kopiją.',
	'CONTACT_ADMIN'			=> 'Siųsti pranešimą administracijai',
	...
	'EMPTY_SENDER_EMAIL'	=> 'Turite įvesti teisingą el. pašto adresą.',
	...
	'LOGIN_EXPLAIN_TEAM'		=> 'Norint peržiūrėti mūsų komandos sąrašą, reikia būti prisijungusiam.',
	'LOGIN_EXPLAIN_MEMBERLIST'	=> 'Norint peržiūrėti diskusijų dalyvių sąrašą, reikia būti prisijungusiam.',
	'LOGIN_EXPLAIN_SEARCHUSER'	=> 'Norint ieškoti vartotojų, reikia būti prisijungusiam.',
	'LOGIN_EXPLAIN_VIEWPROFILE'	=> 'Norint peržiūrėti vartotojų aprašymus, reikia būti prisijungusiam.',

	'MANAGE_GROUP'			=> 'Grupės valdymas',
	'MORE_THAN'	=> 'Daugiau nei',

	'NO_CONTACT_FORM'		=> 'Susisiekimo su administracija forma yra išjungta.',
	'NO_CONTACT_PAGE'		=> 'Puslapis, skirtas susisiekti su administracija, yra išjungtas.',
	...
	'SENDER_EMAIL_ADDRESS'	=> 'Jūsų elektroninio pašto adresas',
	...
	'USER_LAST_REMINDED'	=> [
		0		=> 'Šiuo metu nėra išsiųstų priminimų',
		1		=> 'Išsiųstas  %1$d priminimas<br />» %2$s',
		2		=> 'Išsiųsti %1$d priminimai<br />» %2$s',
		3		=> 'Išsiųsti %1$d priminimai<br />» %2$s',
	],
	'USER_ONLINE'	=> 'Prisijungęs',
	'USER_PRESENCE'	=> 'Buvimas diskusijose',
	'USERS_PER_PAGE'		=> 'Vartotojų puslapyje',
	...
	'VIEW_YOUTUBE_PROFILE'	=> 'Žiūrėti YouTube profilį',
]);
