...
$lang = array_merge($lang, [
	...
	'ADD_GROUP_CATEGORY'			=> 'Pridėti kategoriją',
	...
	'GROUP_CATEGORY_NAME'			=> 'Kategorijos pavadinimas',
	'GROUP_CLOSED'	=> 'Uždara',
	...
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'Ar tikrai norite pridėti vartotoją %2$s į šią grupę?',
		2	=> 'Ar tikrai norite pridėti vartotojus %2$s į šią grupę?',
		3	=> 'Ar tikrai norite pridėti vartotojus %2$s į šią grupę?',
	),
	...
	'GROUP_SPECIAL'					=> 'Iš anksto įdiegta',
	'GROUP_TEAMPAGE'				=> 'Rodyti grupę informacijos apie komandą puslapyje',
	...
	'GROUP_USERS_INVALID'			=> 'Vartotojai nebuvo įtraukti į grupę, nes šių paskyrų nėra: %s',

	'LEGEND_EXPLAIN'				=> 'Grupės parodytos legendoje:',
	'LEGEND_SETTINGS'				=> 'Grupės legendos nustatymai',
	'LEGEND_SORT_GROUPNAME'			=> 'Rūšiuoti pagal pavadinimą',
	'LEGEND_SORT_GROUPNAME_EXPLAIN'	=> 'Ši rūšiavimo tvarka bus ignoruojama.',

	'MANAGE_LEGEND'			=> 'Tvarkyti grupių legendas',
	'MANAGE_TEAMPAGE'		=> 'Tvarkyti informaciją apie komandą',
	'MAKE_DEFAULT_FOR_ALL'	=> 'Nustatyti grupę kaip pagrindinę visiems nariams',
	'MEMBERS'	=> 'Nariai',

	'NO_GROUP'	=> 'Nenurodyta grupė.',
	'NO_GROUPS_ADDED'			=> 'Grupės dar nepridėtos.',
	...
	'TEAMPAGE'					=> 'Informacijos apie komandą puslapis',
	'TEAMPAGE_DISP_ALL'			=> 'Visos grupės',
	'TEAMPAGE_DISP_DEFAULT'		=> 'Tik grupė pagal nutylėjimą',
	'TEAMPAGE_DISP_FIRST'		=> 'Tik pirmoji grupė',
	'TEAMPAGE_EXPLAIN'			=> 'Grupės, kurios yra rodomos komandos informacijos puslapyje:',
	'TEAMPAGE_FORUMS'			=> 'Rodyti moderuojamus forumus',
	'TEAMPAGE_FORUMS_EXPLAIN'	=> 'Jeigu įjungta, prie kiekvieno moderatoriaus bus rodomas jo moderuojamų forumų sąrašas. Didina duomenų bazės apkrovą didelėse konferencijose.',
	'TEAMPAGE_MEMBERSHIPS'		=> 'Rodyti grupes',
	'TEAMPAGE_SETTINGS'			=> 'Informacijos apie komandą puslapio nustatymai',
