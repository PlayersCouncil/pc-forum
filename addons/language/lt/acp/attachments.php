...
$lang = array_merge($lang, [
	...
	'ATTACH_POST_TYPE'					=> 'Pranešimo tipas',
	...
	'FILES_GONE'			=> 'Kai kurie ištrynimui pasirinkti priedai neegzistuoja. Galbūt jie jau buvo ištrinti anksčiau. Esami priedai sėkmingai ištrinti.',
	'FILES_STATS_WRONG'		=> 'Priedų statistika gali būti neteisinga ir ją reikia sinchronizuoti. Teisingos vertės: priedų skaičius = %1$d, bendras priedų dydis = %2$s.<br />Spustelėkite %3$sčia%4$s, kad sinchronizuoti priedų statistiką.',
	...
	'IMAGE_QUALITY'				=> 'Įkeltų vaizdų kokybė (tik JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Nurodykite reikšmę nuo 50 % (mažesnis galutinio failo dydis) iki 90 % (geresnė kokybė). Aukštesnė nei 90 % kokybė padidina galutinio failo dydį, todėl yra išjungta. Šis nustatymas taikomas tik tuo atveju, jei maksimalūs vaizdo dydžiai yra kitokie nei 0 x 0 pikselių.',
	'IMAGE_STRIP_METADATA'		=> 'Pašalinti vaizdo metaduomenis (tik JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Pašalinti Exif metaduomenis, tokius kauo autoriaus pavardė, GPS koordinatės ir fotografavimo parametrai. Šis nustatymas taikomas tik tuo atveju, jei nustatyti didžiausi vaizdo dydžiai, išskyrus 0 x 0 pikselių.',
	...
	'NO_ATTACHMENTS'			=> 'Nurodytu laikotarpiu priedų nerasta.',
	'NO_EXT_GROUP'	=> 'Nėra',
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Nėra <a href="%s">leidžiamų plėtinių grupių</a> asmeninėms žinutėms.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Pranešimams nėra <a href="%s">leidžiamų plėtinių grupių</a>.',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Ar tikrai norite sinchronizuoti priedų statistiką?',
	...
	'UPLOAD_POST_NOT_EXIST'			=> 'Nepavyko įkelti failo „%1$s“ į pranešimą %2$d. Šis pranešimas neegzistuoja.',
]);
