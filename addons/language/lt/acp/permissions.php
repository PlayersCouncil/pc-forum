...
$lang = array_merge($lang, [
	'ACP_PERMISSIONS_EXPLAIN'	=> '		<p>Teisių valdymas yra labai tikslus ir sugrupuotas į keturis pagrindinius skyrius, kurie yra:</p>
		<p>Leidimai yra labai išsamūs ir sugrupuoti į keturias pagrindines dalis:</p>

		<h2>Globalūs prieigų leidimai</h2>
		<p>Šios teisės naudojamos prieigai valdyti globaliame lygmenyje ir taikomos visai konferencijai. Jos dar skirstomi į vartotojų, grupių, administratorių ir super moderatorių teises.</p>

		<h2>Vietiniai prieigų leidimai</h2>
		<p>Šios teisės naudojamos prieigai valdyti forumų lygmeniu. Jos dar skirstomos į: Prieiga prie forumų, Forumų moderatoriai, Forumo vartotojų teisės, Forumo grupių teisės.</p>

		<h2>Rolės</h2>
		<p>Jos yra naudojamos skirtingiems standartiniams prieigos teisių rinkiniams sukurti, kad vėliau būtų galima priskirti teises, remiantis vaidmenimis pagrįstą prieigą. Rolių rinkinys pagal nutylėjimą turėtų visiškai atitikti didelių ir mažų konferencijų administravimo poreikius, tačiau kiekviename iš keturių skyrių galite pridėti, keisti ir ištrinti roles, kaip jums atrodo tinkama.</p>

		<h2>Prieigos leidimų kaukės</h2>
		<p>Prieigos leidimų kaukės yra naudojamos norint peržiūrėti dabartines prieigos teises, priskirtas vartotojams, moderatoriams (vietiniams ir super moderatoriams), administratoriams ir forumams.</p>

		<br />

		<p>Norėdami gauti daugiau informacijos apie prieigos teisių nustatymą ir tvarkymą phpBB3 konferencijoje, žiūrėkite <a href="https://www.phpbbguru.net/documentation/admin/permissions/">Mūsų vadovo 3.7 skyrių</a>.</p>
	',
