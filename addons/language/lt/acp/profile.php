...
$lang = array_merge($lang, [
	...
	'ALPHA_DOTS'			=> 'Tik lotyniškos abėcėlės simboliai, skaičiai ir taškai',
	'ALPHA_ONLY'	=> 'Tik raidės ir skaičiai',
	'ALPHA_SPACERS'	=> 'Raidės, skaičiai ir specialieji simboliai',
	'ALPHA_UNDERSCORE'		=> 'Tik lotyniškos abėcėlės simboliai, skaičiai ir apatiniai brūkšniai',
	'ALPHA_PUNCTUATION'		=> 'Tik lotyniškos abėcėlės simboliai, skaičiai, kableliai, taškai, apatiniai brūkšniai ir brūkšniai, prasidedantys lotyniškomis raidėmis',
	...
	'DISPLAY_ON_MEMBERLIST'			=> 'Rodyti vartotojų sąraše.',
	'DISPLAY_ON_MEMBERLIST_EXPLAIN'	=> 'Jei įjungta, laukas bus rodomas vartotojų sąrašo puslapyje.',
	'DISPLAY_ON_PM'					=> 'Rodyti, kai žiūrite asmenines žinutes',
	'DISPLAY_ON_PM_EXPLAIN'			=> 'Jei įjungta, šis laukas bus rodomas jūsų mini profilyje peržiūrint asmenines žinutes.',
	...
	'FIELD_CONTACT_DESC'		=> 'Kontakto aprašymas',
	'FIELD_CONTACT_URL'			=> 'Nuoroda į kontaktus',
	'FIELD_DATE'	=> 'Data',
	...
	'FIELD_INT'	=> 'Skaičiai',
	'FIELD_IS_CONTACT'			=> 'Rodyti lauką kaip kontaktinę informaciją',
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Kontaktų laukas rodomas vartotojo profilio kontaktų skiltyje, taip pat mini profiliuose peržiūrint temas ir privačias žinutes. Galima naudoti eilutės leksemą <samp>%s</samp>, kuri bus pakeista vartotojo nurodyta reikšme.',
	...
	'LETTER_NUM_DOTS'			=> 'Bet kokie abėcėlės simboliai, skaičiai ir taškai',
	'LETTER_NUM_ONLY'			=> 'Bet kokie abėcėlės simboliai ir skaičiai',
	'LETTER_NUM_PUNCTUATION'	=> 'Bet kokie abėcėlės simboliai, skaičiai, kableliai, taškai, apatiniai brūkšniai ir brūkšniai, prasidedantys bet kuria raide',
	'LETTER_NUM_SPACERS'		=> 'Bet kokie abėcėlės simboliai, skaičiai ir skyrikliai',
	'LETTER_NUM_UNDERSCORE'		=> 'Bet kokie abėcėlės simboliai, skaičiai ir apatiniai brūkšniai',
