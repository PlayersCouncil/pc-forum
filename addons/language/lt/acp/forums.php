...
$lang = array_merge($lang, [
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'Nuorodų į perkeltas temas automatinio valymo dažnis',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'Amžius nuorodų į perkeltas temas (automatiniam valymui)',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Dienų skaičius, po kurio bus ištrinta nuoroda į perkeltą temą.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Laikas dienomis tarp automatinio valymo vykdymų.',
	...
	'FORUM_NAME_EMOJI'					=> 'Įvestas neteisingas forumo pavadinimas.<br>Šie vardo simboliai nepalaikomi:<br>%s',
	...
	'FORUM_PRUNE_SHADOW'				=> 'Įgalinti automatinį valymą nuorodų į perkeltas temas',
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> 'Automatinis forumų valymas nuo nuorodų į temas, perkeltas į kitus forumus. Žemiau nustatykite perkeltų temų automatinio valymo dažnumą ir amžių.',
	...
	'LINK'	=> 'Nuoroda',
	'LIMIT_SUBFORUMS'			=> 'Sąraše rodyti tik savo subforumus',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Apriboja subforumų sąrašą tik tiems, kuriems šis forumas yra motininis (pirmasis įdėjimo lygis). Kai ši parinktis išjungta, sąraše bus rodomi visi šio forumo subforumai (nepriklausomai nuo įdėjimo lygio), kuriems įjungtas nustatymas „Rodyti forumą subforumo sąraše“.',
