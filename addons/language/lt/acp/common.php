...
$lang = array_merge($lang, [
	...
	'ACP_CAT_CUSTOMISE'			=> 'Personalizavimas',
	...
	'ACP_CONTACT'				=> 'Puslapis, skirtas susisiekti su administracija',
	'ACP_CONTACT_SETTINGS'		=> 'Nustatymai puslapio, skirto susisiekti su administracija',
	...
	'ACP_EXTENSION_MANAGEMENT'	=> 'Plėtinių valdymas',
	'ACP_EXTENSIONS'			=> 'Plėtinių valdymas',
	...
	'ACP_GROUPS_POSITION'			=> 'Grupės išdėstymo valdymas',

	'ACP_HELP_PHPBB'			=> 'Padėkite palaikyti phpBB',
	...
	'ACP_MANAGE_ATTACHMENTS'			=> 'Priedų valdymas',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Čia galite peržiūrėti ir ištrinti priedus, pridėtus prie pranešimų temose ir privačiuose pranešimuose.',
	...
	'ACP_STYLES'	=> 'Stiliai',
	'ACP_STYLES_CACHE'			=> 'Išvalyti kešą',
	'ACP_STYLES_INSTALL'		=> 'Instaliuoti stilius',
	...
	'CONTAINER_EXCEPTION' 	=> 'Kompiliuojant konteinerį, susijusį su vienu iš įdiegtų plėtinių, įvyko phpBB klaida. Dėl šios priežasties visi įdiegti plėtiniai buvo laikinai išjungti. Pabandykite išvalyti konferencijos kešą. Visi plėtiniai bus automatiškai įjungti, jei bus išspręsta konteinerio klaida. Kitu atveju susisiekite su oficialia palaikymo svetaine <a href="https://www.phpbb.com">phpBB</a> kad gauti pagalbą.',
	'EXCEPTION' 			=> 'Išimtis',

	'COLOUR_SWATCH'	=> 'Spalvų paletė',
	'CONFIG_UPDATED'	=> 'Konfigūracija sėkmingai atnaujinta.',
	'CRON_LOCK_ERROR'		=> 'Nepavyko gauti planuoklio blokavimą (cron lock).',
	'CRON_NO_SUCH_TASK'		=> 'Nepavyko rasti planuotojo užduoties „%s“.',
	'CRON_NO_TASK'			=> 'Šiuo metu nėra jokių planavimo užduočių, kurias būtų galima vykdyti.',
	'CRON_NO_TASKS'			=> 'Nepavyko rasti planuotojo užduočių.',
	'CSV_INVALID'			=> 'Kableliais atskirtas sąrašas „%1$s“ yra netinkamai suformatuotas. Sąrašo reikšmės skyriklis gali būti tik kablelis. Skirtiklis negali būti sąrašo pradžioje arba pabaigoje.',
	...
	'LOAD_NOTIFICATIONS'			=> 'Rodyti pranešimus',
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> 'Rodyti pranešimų sąrašą kiekviename puslapyje (dažniausiai viršuje).',
	...
	'NO_FILES_TO_DELETE'	=> 'Priedai, kuriuos pasirinkote ištrinti, neegzistuoja.',
	...
	'RELEASE_ANNOUNCEMENT'				=> 'Skelbimas',
	'REMIND'	=> 'Priminti',
	'REPARSE_LOCK_ERROR'				=> 'Apdorojimą jau naudoja kitas procesas.',
	'RESYNC'	=> 'Sinchronizuoti',

	'RUNNING_TASK'			=> 'Vykdoma užduotis : %s.',
	...
	'TASKS_NOT_READY'			=> 'Nesuplanuotos užduotys:',
	'TASKS_READY'			=> 'Suplanuotos užduotys:',
	'TOTAL_SIZE'			=> 'Bendras dydis',

	'UCP'	=> 'Vartotojo valdymo pultas',
	'URL_INVALID'			=> 'Įvesta „%1$s“ nustatymo nuoroda neteisinga.',
	'URL_SCHEME_INVALID'	=> 'Protokolo pavadinimas „%2$s“ nustatyme „%1$s“ yra netinkamo formato. Protokolo pavadinimas turi prasidėti lotynišku simboliu ir jame gali būti tik lotyniški simboliai, skaičiai, brūkšneliai ir taškai.',
	'USERNAMES_EXPLAIN'	=> 'Kiekvieną vartotojo vardą rašykite naujoje eilutėje.',
	'USER_CONTROL_PANEL'	=> 'Vartotojo valdymo pultas',

	'UPDATE_NEEDED'			=> 'Konferenciją reikia atnaujinti.',
	'UPDATE_NOT_NEEDED'		=> 'Konferencija buvo atnaujinta.',
...
$lang = array_merge($lang, [
	...
	'ERROR_DEFAULT_CHARSET'							=> 'Simbolių koduotė pagal nutylėjimą nėra tinkamai sukonfigūruota',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> 'Parametras <var>default_charset</var> turi būti lygus <samp>UTF-8</samp>. Dabartinę vertę galite patikrinti puslapyje <samp>Duomenys apie PHP</samp>.',
	...
	'NO_SEARCH_INDEX'	=> 'Pasirinktam paieškos varikliui „%1$s“ nėra paieškos indeksų.<br />Sukurkite juos skyriuje %2$sPaieškos indeksai%3$s.',
	...
	'PHP_VERSION_OLD'	=> 'PHP versija šiame serveryje (%1$s) nebebus palaikoma būsimos phpBB versijos. Minimali reikalinga versija bus PHP %2$s. %3$sIšsami informacija%4$s',		
	...
	'PURGE_CACHE_SUCCESS'	=> 'Kešas sėkmingas išvalytas.',
	...
	'PURGE_SESSIONS_SUCCESS'	=> 'Seansai sėkmingai išvalyti.',
	...
	'RESET_DATE_SUCCESS'				=> 'Konferencijos pradžios data sėkmingai nustatyta iš naujo',
	...
	'RESET_ONLINE_SUCCESS'				=> 'Konferencijos dalyvių rekordas sėkmingai ištrintas ir nunulintas',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Pranešimų skaitikliai sėkmingai sinchronizuoti',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Jūsų temos sėkmingai sinchronizuotos',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Statistika sėkmingai sinchronizuota',
	'RUN'	=> 'Pradėti',

	'STATISTIC'	=> 'Duomuo',
	'STATISTIC_RESYNC_OPTIONS'	=> 'Duomenų suskaičiavimas arba ištrynimas',

	'TIMEZONE_INVALID'	=> 'Pasirinkta laiko juosta yra neteisinga.',
	'TIMEZONE_SELECTED'	=> '(dabartinis)',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Patikrinti, ar dabartinė phpBB versija yra naujausia.',
	'VERSIONCHECK_INVALID_ENTRY'	=> 'Naujausios versijos informacijoje yra nepalaikomas įrašas.',
	'VERSIONCHECK_INVALID_URL'		=> 'Naujausios versijos informacijoje yra neteisinga nuoroda.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'Naujausios versijos informacijoje yra neteisinga versijos reikšmė.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Jūsų phpBB versija nėra naujausia.<br />Žemiau rasite nuorodą į naujausios versijos pranešimą, kuriame yra papildomos informacijos ir instrukcijos, kaip atnaujinti phpBB.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Jūsų phpBB versija nėra pati naujausia.',
	'VERSION_UP_TO_DATE_ACP'		=> 'Jūsų phpBB versija yra naujausia. Šiuo metu jai nėra jokių atnaujinimų.',
...
$lang = array_merge($lang, [
	...
	'SEND_STATISTICS_LONG'		=> 'Statistinės informacijos siuntimas',
	'SHOW_STATISTICS'	=> 'Parodyti detales',
	'THANKS_SEND_STATISTICS'	=> 'Dėkojame, kad atsiuntėte mums informaciją.',
	'FAIL_SEND_STATISTICS'		=> 'Nepavyko išsiųsti statistikos',
]);
...
$lang = array_merge($lang, [
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>BBCode konfiguracijos klaida</strong>: %1$s<br />» %2$s',
	...
	'LOG_DELETE_POST'	=> '<strong>Ištrintas pranešimas “%1$s”, kurio autorius “%2$s” dėl sekančios priežasties</strong><br />» %3$s',	
	'LOG_DELETE_SHADOW_TOPIC'	=> '<strong>Ištrintas šešėlinė tema</strong><br />» %s',	
	'LOG_DELETE_TOPIC'	=> '<strong>Ištrinta tema “%1$s”, kurios autorius “%2$s” dėl sekančios priežasties</strong><br />» %3$s',	
	...
	'LOG_MOVED_TOPIC'			=> '<strong>Tema perkelta</strong><br />» %s',
	'LOG_PM_REPORT_CLOSED'	=> '<strong>Uždarytas asmeninės žinutės raportas</strong><br />» %s',
	'LOG_PM_REPORT_DELETED'	=> '<strong>Ištrintas asmeninės žinutės raportas</strong><br />» %s',
	'LOG_POST_APPROVED'	=> '<strong>Patvirtintas pranešimas</strong><br />» %s',
	'LOG_POST_DISAPPROVED'	=> '<strong>Atmestas pranešimas “%1$s”, parašytas autoriaus “%3$s” dėl sekančios priežasties</strong><br />» %2$s',	
	'LOG_POST_EDITED'	=> '<strong>Redaguotas pranešimas “%1$s”, kurio autorius “%2$s” dėl sekančios priežasties</strong><br />» %3$s',	
	'LOG_POST_RESTORED'			=> '<strong>Pranešimas atkurtas</strong><br />» %s',
	'LOG_REPORT_CLOSED'	=> '<strong>Uždarytas raportas</strong><br />» %s',
	'LOG_REPORT_DELETED'	=> '<strong>Ištrintas raportas</strong><br />» %s',
	'LOG_RESTORE_TOPIC'			=> '<strong>Atkurta vartotojo sukurta tema „%1$s“</strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'		=> '<strong>УNaudotojo „%2$s“ sukurtas pranešimas „%1$s“ buvo įtrauktas į šiukšliadėžę dėl šios priežasties</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'		=> '<strong>Tema „%1$s“, kurią sukūrė naudotojas „%2$s“, buvo pašalinta į šiukšliadėžę dėl</strong><br />» %3$s',
	...
	'LOG_TOPIC_RESTORED'		=> '<strong>Atkurta tema </strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'	=> '<strong>Atmesta tema “%1$s”, parašyta autoriaus “%3$s” dėl sekančios priežasties</strong><br />» %2$s',	
	...
	'LOG_ERROR_CAPTCHA'		=> '<strong>CAPTCHA klaida</strong><br />» %s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED'		=> '<strong>Nepavyko atidaryti %1$s valymui, patikrinkite leidimus.</strong><br />Išimtis: %2$s<br />Papildoma informacija: %3$s',
	...
	'LOG_PRUNE_SHADOW'		=> '<strong>Atliktas automatinis nuorodų į perkeltas temas išvalymas</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Priedų statistika buvo sinchronizuota</strong>',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Sphinx klaida</strong><br />В» %s',

	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> '„Spamhaus“ neleidžia pateikti užklausų naudojant DNS serverius, kurie veikia pagal principą open resolver. Patikrinimas buvo išjungtas.Papildoma informacija: https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> 'Višyta Spamhaus užklausų skaičiaus riba. Patikrinimas buvo išjungtas. Papildoma informacija: https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	...
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>Ištrintas vartotojo perspėjimas</strong><br />» %1$s',
		2 => '<strong>Ištrinti %2$d vartotojo perspėjimai</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
		3 => '<strong>Ištrinti %2$d vartotojo perspėjimai</strong><br />» %1$s',
	),
	...
	'LOG_EXT_ENABLE'	=> '<strong>Plėtinys įjungtas</strong><br />» %s',
	'LOG_EXT_DISABLE'	=> '<strong>Plėtinys išjungtas</strong><br />» %s',
	'LOG_EXT_PURGE'		=> '<strong>Plėtinio duomenys ištrinti</strong><br />» %s',
	'LOG_EXT_UPDATE'	=> '<strong>Plėtinys atnaujintas</strong><br />» %s',
]);
