...
$lang = array_merge($lang, [
	...
	<br><br>
	Mūsų diskusijos naudoja phpBB programinę įrangą (toliau “jie”, “jų”, “phpBB programinė įranga”, “www.phpbb.com”, “phpBB Grupė”, “phpBB Komanda”) išleistą po “<a href="http://opensource.org/licenses/gpl-2.0.php">GNU General Public License v2</a>” (toliau “GPL”). Ją galima atsisiųsti iš <a href="https://www.phpbb.com/">www.phpbb.com</a> puslapio. phpBB programinė įranga tik palengvina Internetinį bendravimą, o GPL licencija užtikrina, kad jie neturi nieko bendro su tuo, ką mes leidžiame ir ko neleidžiame diskusijose. Daugiau informacijos apie phpBB galite rasti: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	...
	'PRIVACY_POLICY'	=> 'Ši privatumo politika detaliai apibūdina kaip “%1$s” kartu su jai atstovaujančioms kompanijoms (toliau “mes”, “mūsų”, “%1$s”, “%2$s”) bei phpBB (toliau “jie”, “jų”, “phpBB programinė įranga”, “www.phpbb.com”, “phpBB Grupė”, “phpBB Komanda”) naudoja bet kurios sesijos metu surinktą informaciją (toliau “jūsų informacija”).
	<br><br>
...
$lang = array_merge($lang, [
	...
	'ATTACHMENT_LOCKED'				=> 'Ši tema uždaryta, priedo ištrinti negalima.',
	'AUTOLOGIN_SESSION_KEYS_DELETED'=> 'Pasirinkti prisijungimo prie funkcijos "Prisiminti mane" raktai buvo sėkmingai ištrinti.',
	'AVATAR_CATEGORY'	=> 'Kategorija',
	'AVATAR_DRIVER_GRAVATAR_TITLE'	=> 'Gravataras',
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Gravataras - paslauga, leidžianti naudoti tą patį avatarą keliose svetainėse. Daugiau informacijos svetainėje <a href="http://www.gravatar.com/">Gravataras</a>.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Avatarų galerija',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Galite pasirinkti avatarą iš tų, kuriuos galite rasti šios konferencijos galerijoje.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Nutolęs avataras',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Nuoroda į avatarą, esantį kitoje svetainėje.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Kraunamas avataras',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Įkelkite savo avatarą.',
	'AVATAR_EXPLAIN'	=> 'Maksimalūs dydžiai; plotis: %1$s pikseliai, aukštis: %2$s pikseliai, failo dydis: %3$.2f kB.',
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> 'Maksimalūs dydžiai: plotis ne daugiau %1$s, aukštis ne daugiau %2$s.',
	...
	'AVATAR_SELECT'					=> 'Pasirinkite avatarą',
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Laukelis “%2$s” per trumpas, mažiausias leistinas ilgis yra %1$d simbolis.',
		2	=> 'Laukelis “%2$s” per trumpas, mažiausias leistinas ilgis yra %1$d simbolių.',
		3	=> 'Laukelis “%2$s” per trumpas, mažiausias leistinas ilgis yra %1$d simbolių.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Laukelis “%2$s” per ilgas, didžiausias leistinas ilgis yra %1$d simbolis.',
		2	=> 'Laukelis “%2$s” per ilgas, didžiausias leistinas ilgis yra %1$d simbolių.',
		3	=> 'Laukelis “%2$s” per ilgas, didžiausias leistinas ilgis yra %1$d simbolių.',
	),
	...
	'FIELD_INVALID_CHARS_INVALID'		=> 'Laukelyje “%s” yra neleistinų simbolių.',
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'Laukelyje “%s” yra neleistinų simbolių. Jame galima rašyti tik skaičius.',
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik lotyniškos abėcėlės ženklai, skaičiai ir taškas (.).',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Laukelyje “%s” yra neleistinų simbolių. Jame galima rašyti tik skaičius ir raides.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik lotyniškos abėcėlės ženklai, skaičiai, skyrybos ženklai _,-. ir pirmasis simbolis turi būti lotyniška raidė.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik lotyniškos abėcėlės ženklai, skaičiai, tarpai ir skyrikliai -+_[].',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik lotyniškos abėcėlės ženklai, skaičiai ir pabraukimas.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik abėcėlės simboliai, skaičiai ir taškas (.).',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik abėcėlės simboliai ir skaičiai.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik abėcėlės simboliai, skaičiai, skyrybos ženklai _,-. ir pirmasis simbolis turi būti raidė.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik abėcėlės simboliai, skaičiai, tarpas ir skyrikliai -+_[].',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Laukelyje “%s” yra neleistinų simbolių, leidžiami tik abėcėlės simboliai, skaičiai ir apatiniai brūkšniai.',
	'FIELD_INVALID_DATE'	=> 'Laukelyje “%s” įrašyta neteisinga data.',
	'FIELD_INVALID_URL'					=> 'Laukelyje “%s” yra neleistinas url adresas.',
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Kataloge užimta %3$d%% (saugoma %2$d iš %1$s žinučių)',
		2	=> 'Kataloge užimta %3$d%% (saugoma %2$d iš %1$s žinučių)',
		3	=> 'Kataloge užimta %3$d%% (saugoma %2$d iš %1$s žinučių)',
	),
	...
	'GRAVATAR_AVATAR_EMAIL'			=> 'Gravataro emailo adresas',
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Įveskite emailo adresą, panaudotą registruojant paskyrą svetainėje <a href="http://www.gravatar.com/">Gravataras</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Avataro dydis',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Nurodykite avataro plotį ir aukštį. Palikite laukus tuščius, kad automatiškai nustatytų dydį.',
	...
	'LOGIN_LINK'					=> 'Susieti išorinės paslaugos paskyrą su konferencijos paskyra arba sukurti naują.',
	'LOGIN_LINK_EXPLAIN'			=> 'Bandėte prisijungti naudodami paskyrą iš kitos paslaugos, kuri dar nesusieta su konferencijos paskyra. Turite susieti šią paskyrą su esama arba susikurti naują paskyrą konferencijoje.',
	'LOGIN_LINK_MISSING_DATA'		=> 'Duomenų, reikalingų norint susieti konferencijos paskyrą su išorinės paslaugos paskyra, nėra. Pakartokite autorizacijos procedūrą.',
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Nepateikta duomenų, kad būtų galima susieti išorinės paslaugos paskyrą su konferencijos paskyra. Jei problema išlieka, susisiekite su konferencijos administratoriumi.',
	...
	'MESSAGE_REPORTED_MESSAGE'		=> 'Apskųstas pranešimas',
	'MESSAGE_SENT_ON'	=> '',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Keliant žinutes į naują katalogą įvyko klaida. Perkeltos tik: %2$d iš %1$s žinučių.',
		2	=> 'Keliant žinutes į naują katalogą įvyko klaida. Perkeltos tik: %2$d iš %1$s žinučių.',
		3	=> 'Keliant žinutes į naują katalogą įvyko klaida. Perkeltos tik: %2$d iš %1$s žinučių.',
	),
	...
	'NOTIFICATIONS_MARK_ALL_READ'						=> 'Pažymėti visus pranešimus kaip perskaitytus',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'Ar tikrai norite pažymėti visus pranešimus kaip perskaitytus?',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> 'Visi pranešimai pažymėti kaip perskaityti.',
	'NOTIFICATION_GROUP_MISCELLANEOUS'					=> 'Kiti pranešimai',
	'NOTIFICATION_GROUP_MODERATION'						=> 'Moderavimo pranešimai',
	'NOTIFICATION_GROUP_ADMINISTRATION'					=> 'Administravimo pranešimai',
	'NOTIFICATION_GROUP_POSTING'						=> 'Informavimas apie pranešimus',
	'NOTIFICATION_METHOD_BOARD'							=> 'Pranešimai',
	'NOTIFICATION_METHOD_EMAIL'							=> 'Email',
	'NOTIFICATION_METHOD_JABBER'						=> 'Jabber',
	'NOTIFICATION_TYPE'									=> 'Pranešimo tipas',
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Pažymėtoje temoje yra naujų pranešimų.',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Gautas prašymas prisijungti prie grupės, kurios lyderis esate jūs.',
	'NOTIFICATION_TYPE_FORUM'							=> 'Forume, kurį užsiprenumeravote, yra naujų pranešimų.',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'Įrašą ar temą reikia patvirtinti',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'Jūsų pranešimai/temos, kurias patvirtino arba atmetė moderatorius',
	'NOTIFICATION_TYPE_PM'								=> 'Jums buvo išsiųsta asmeninė ​​žinutė',
	'NOTIFICATION_TYPE_POST'							=> 'Temoje, kurią prenumeruojate, yra naujų pranešimų.',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Jūs buvote cituojamas žinutėje',
	'NOTIFICATION_TYPE_REPORT'							=> 'Skundai dėl žinučių',
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Moderatorius uždarė jūsų skundą dėl pranešimo.',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Gautas skundas dėl asmeninės žinutės',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Jūsų skundą dėl privačios žinutės uždarė moderatorius.',
	'NOTIFICATION_TYPE_TOPIC'							=> 'Forume, prie kurio užsiprenumeravote, yra naujų temų.',
	'NOTIFICATION_TYPE_ADMIN_ACTIVATE_USER'				=> 'Vartotojas, kurį reikia aktyvuoti',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Jūsų asmeninių žinučių katalogas pilnas. Pas Jus %d atidėtas pranešimas',
		2	=> 'Jūsų asmeninių žinučių katalogas pilnas. Pas Jus %d atidėti pranešimai',
		3	=> 'Jūsų asmeninių žinučių katalogas pilnas. Pas Jus %d atidėti pranešimai',
	),
	'NO_ACTION_MODE'	=> 'Nenurodytas žinutės veiksmas.',
	'NO_AUTHOR'	=> 'Nenurodytas žinutės autorius',
	'NO_AVATAR'						=> 'Nepasirinktas avataras',
	...
	'NO_AUTH_PROFILEINFO'			=> 'Pas Jus nėra prieigos keisti profilį.',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Pas Jus nėra prieigos spausdinti asmeninius pranešimus.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'Nurodytą el. pašto adresą naudoja keli vartotojai. Turite pateikti vartotojo vardą.',
	...
	'NO_RESET_TOKEN'			=> 'Jūs neįvedėte slaptažodžio atkūrimo kodo.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Slaptažodis turi būti ne trumpesnis nei %1$s simbolių. Jame turi būti didžiųjų raidžių, mažųjų raidžių bei skaičių.',
	'PASS_TYPE_ANY_EXPLAIN'	=> 'Slaptažodis turi būti ne trumpesnis nei %1$s simbolių ilgio.',	
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Slaptažodis turi būti ne trumpesnis nei %1$s simbolių ilgio ir jame turi būti didžiųjų bei mažųjų raidžių.',	
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Slaptažodis turi būti ne trumpesnis nei %1$s simbolių ilgio. Jame turi būti didžiųjų raidžių, mažųjų raidžių, skaičių bei specialiųjų simbolių.',	
	'PASSWORD'	=> 'Slaptažodis',
	'PASSWORD_ACTIVATED'	=> 'Jūsų naujas slaptažodis aktyvuotas.',
	'PASSWORD_RESET'			=> 'Jūsų slaptažodis sėkmingai atstatytas.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Jei jūsų paskyra egzistuoja, su šia paskyra susietu el. pašto adresu buvo išsiųsta slaptažodžio nustatymo iš naujo nuoroda. Jei negaunate pranešimo, jūsų paskyra gali būti užrakinta, išjungta, per trumpą laiką išsiuntėte kelias slaptažodžio nustatymo užklausas arba neturite prieigos pakeisti slaptažodį. Tokiais atvejais kreipkitės į konferencijos administratorių. Be to, įsitikinkite, kad pranešimas nebuvo filtruojamas kaip spamas.',
	...
	'PM_INBOX'	=> 'Gautos',
	'PM_MARK_ALL_READ'			=> 'Pažymėti visus pranešimus kaip perskaitytus',
	'PM_MARK_ALL_READ_SUCCESS'	=> 'Visos asmeninės žinutės šiame aplanke pažymėtos kaip perskaitytos',
	'PM_NO_USERS'	=> 'Nurodyti vartotojai neegzistuoja.',
	'PM_OUTBOX'	=> 'Siunčiamos',
	'PM_SENTBOX'	=> 'Išsiųstos',
	'PM_SUBJECT'	=> 'Žinutės tema',
	'PM_TO'	=> 'Kam',
	'PM_TOOLS'					=> 'Tvarkyti asmenines žinutes',
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'Kai kurių vartotojų negalima pridėti, nes jie neturi leidimo skaityti asmeninių žinučių.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Funkcijos "Prisiminti mane" prisijungimo raktai automatiškai autorizuos jus dalyvauti konferencijoje. Jei jūs išėjote iš konferencijos, prisijungimo raktai ištrinami tiktais tame kompiuteryje, kuriame buvo atsijungta. Čia galite peržiūrėti raktus kitų kompiuterių, kuriuos naudojote dalyvaudami šioje konferencijoje.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Funkcijos "Prisiminti mane" prisijungimo raktų nėra.',

	'RECIPIENT'	=> 'Gavėjas',
	'RECIPIENTS'	=> 'Gavėjai',
	'REGISTRATION'	=> 'Registracija',
	'OAUTH_REGISTRATION'				=> 'Registracija naudojant išorines autentifikavimo paslaugas',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Įvestas slaptažodžio atkūrimo kodas yra neteisingas arba jo galiojimo laikas jau pasibaigęs.',
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> 'Asmeninių žinučių filtrai ištrynė %d asmeninę žinutę',
		2	=> 'Asmeninių žinučių filtrai ištrynė %d asmeninių žinučių',
		3	=> 'Asmeninių žinučių filtrai ištrynė %d asmeninių žinučių',
	),
	...
	'SELECT_CURRENT_TIME'		=> 'Pasirinkti dabartinį laiką',
	'SELECT_TIMEZONE'			=> 'Pasirinkti laiko juostą',
	'SORT'	=> 'Rūšiuoti',
	...
	'TIMEZONE_DATE_SUGGESTION'	=> 'Prielaida: %s',
	'TIMEZONE_INVALID'			=> 'Pasirinkta netinkama laiko juosta.',
	'TO'	=> 'Kam',
	'TO_MASS'					=> 'Gavėjai',
	...
	'UCP_AUTH_LINK_ASK'			=> 'Šiuo metu su paskyra išorinėje paslaugoje nėra susietos paskyros. Spustelėkite toliau esantį mygtuką, kad susietumėte paskyrą su išorinės paslaugos paskyra.',
	'UCP_AUTH_LINK_ID'			=> 'Unikalus identifikatorius',
	'UCP_AUTH_LINK_LINK'		=> 'Pririšimas',
	'UCP_AUTH_LINK_MANAGE'		=> 'Išorinių paslaugų paskyrų susiejimo valdymas',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Dabartinis autorizacijos mechanizmas nepalaiko konferencijų paskyrų susiejimo su išorinėmis paslaugomis.',
	'UCP_AUTH_LINK_TITLE'		=> 'Išorinių paslaugų paskyrų susiejimo valdymas',
	'UCP_AUTH_LINK_UNLINK'		=> 'Ištrinti',
	...
	'UCP_LOGIN_LINK'			=> 'Susieti su išorinės paslaugos paskyra',
	...
	'UCP_NOTIFICATION_LIST'				=> 'Tvarkyti pranešimus',
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> 'Čia galite peržiūrėti gautus pranešimus.',
	'UCP_NOTIFICATION_OPTIONS'			=> 'Pakeisti pranešimų nustatymus',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Čia galite nustatyti pageidaujamus būdus kaip būsite informuoti apie gautus pranešimus konferencijose.',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Funkcijos “Prisiminti mane” prisijungimo raktų tvarkymas',

	'UCP_USERGROUPS'	=> 'Vartotojų grupės',
	'UCP_USERGROUPS_MEMBER'	=> 'Keisti narystę',
	'UCP_USERGROUPS_MANAGE'	=> 'Valdyti grupes',

	'UCP_PASSWORD_RESET_DISABLED'	=> 'Slaptažodžio atkūrimo funkcija yra išjungta. Jei reikia pagalbos atgauti prieigą prie paskyros, susisiekite su %s konferencijos administratoriumi %s',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Vartotojo vardas turi būti nuo %1$s iki %2$s simbolių ilgio. Jame turi būti tik raidės ir skaičiai.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'	=> 'Vartotojo vardas turi būti nuo %1$s iki %2$s simbolių ilgio. Jame turi būti tik raidės, skaičiai, tarpai arba simboliai -+_[].',
	'USERNAME_ASCII_EXPLAIN'	=> 'Vartotojo vardas turi būti nuo %1$s iki %2$s simbolių ilgio. Jame turi būti tik ASCII simboliai be specialiųjų simbolių.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Vartotojo vardas turi būti nuo %1$s iki %2$s simbolių ilgio. Jame turi būti tik raidės ir skaičiai.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'Vartotojo vardas turi būti nuo %1$s iki %2$s simbolių ilgio. Jame turi būti tik raidės, skaičiai, tarpai arba simboliai -+_[].',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Vartotojo vardas turi būti nuo %1$s iki %2$s simbolių ilgio.',
