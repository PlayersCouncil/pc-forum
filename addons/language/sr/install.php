...
$lang = array_merge($lang, array(
	...
	<ul>
		<li>MySQL 4.1.3 или већи (MySQLi захтевано)</li>
...
$lang = array_merge($lang, array(
	...
	'PHP_VERSION_REQD_EXPLAIN'			=> 'phpBB захтева PHP издање 7.2.0 или веће.',
	...
	'PHP_MBSTRING_SUPPORT'				=> 'PHP mbstring подршка',
	'PHP_MBSTRING_SUPPORT_EXPLAIN'		=> 'У настојању да phpBB ради исправно, PHP mbstring проширење треба да буде доступно.',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>Непотпуно ажурирање</h1>
		...
		<p>Запазили смо да последње ажурирање ваше phpBB инсталације ниј’е употпуњено. Посетите <a href="%1$s" title="%1$s">database updater</a>, осигурајте да је <em>Ажурирај само базу</em> одабрано и кликните на <strong>Прихвати</strong>. Не заборавите да обришете "install"-фасциклу након што успешно ажурирате вашу базу.</p>',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Препоручени начин за ажурирање ваше инсталације је full package. Уколико су датотеке phpBB језгра мењане у вашој инсталацији онда је боље да користите пакет за напредно ажурирање у настојању да не изгубите те промене. Такоже сте у могућности да ажурирате вашу инсталацију користећи друге начине који су побројани у INSTALL.html документу. Кораци за phpBB3 ажурирање користећи full package су:</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li><strong class="error">Направите резервни умножак свих датотека вашег форума и базе.</strong></li>
		...
		<h1>Како ажурирати вашу инсталацију са Пакетом за Напредно Ажурирање</h1>

		<p>Овај пакет за напредно ажурирање је препоручљив само за стручњаке у случају да су датотеке phpBB језгра измењене у вашој инсталацији. Такође можете да ажурирате вашу инсталацију користећи начине који су побројани у INSTALL.html документу. Кораци за ажурирање phpBB3 користећи пакет за напредно ажурирање су:</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>Идите до <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">phpBB.com downloads page</a> и преузмите "Пакет за Напредно Ажурирање" архиву.</li>
			<li>Одпакујте архиву.</li>
...
$lang = array_merge($lang, array(
	...
	'COLLIDING_CLEAN_USERNAME'			=> '<strong>%s</strong> је чисто корисничко име за:',
	'COLLIDING_USER'					=> '» корисников id: <strong>%d</strong> корисничко име: <strong>%s</strong> (%d порука)',
	'COLLIDING_USERNAMES_FOUND'			=> 'Корисничка имена у сукобу су пронађена на вашем старом форуму. У настојању да довршите пребацивање молимо обришите или преименујте ове кориснике тако да има само један корисник на вашем старом форуму за свако чисто корисничко име.',
	'CONV_ERR_FATAL'					=> 'Фатална грешка у пребацивању',
