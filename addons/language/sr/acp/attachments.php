...
$lang = array_merge($lang, array(
	...
	'IMAGE_QUALITY'				=> 'Квалитет додатих прилога слика (JPEG само)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Означите вредност измећу 50% (мања величина датотеке) и 90% (већи квалитет). Квалитет већи од 90% повећава величину датотеке и онемогућен је. Поставка се примењује само ако су највеће димензије слике подешене на вредност другачију од 0px са 0px.',
	'IMAGE_STRIP_METADATA'		=> 'Одцепити метаподатке слике (JPEG само)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Одцепити Exif метаподатке, н.пр. име аутора, GPS координате појединости камере. Поставка се примењује само ако су највеће димензије слике подешене на вредност другачију од 0px са 0px.',
	...
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Нема <a href="%s">дозвољених екстензија група</a> за приватне поруке.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Нема <a href="%s">дозвољених екстензија група</a> за поруке.',
	...
	'UPLOAD_POST_NOT_EXIST'			=> 'Датотека “%1$s” не може бити додата поруци под бројем %2$d јер порука не постоји.',
));
