...
$lang = array_merge($lang, array(
	...
	'CSV_INVALID'			=> 'Пружена зарезом-одвојена поставка “%1$s” није ваљана. Вредности могу бити безграничне само са зарезом, не би требало да садрже било какав претходни или пратећи знак.',
	...
	'URL_SCHEME_INVALID'	=> 'Пружена шема “%2$s” у зарезом-одвојеној поставци “%1$s” није ваљана. Шема би требало да почне са латиничним знаком праћеним алфанумеричким знаковима, хифенима или тачкама.',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> мора бити остављено празно. Можете проверити тренутну вредност на <samp>PHP подаци</samp> страници.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP излаз пребацивања знакова је непрописно конфигурисан',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> мора бити остављено празно. Можете проверити тренутну вредност на <samp>PHP подаци</samp> страници.',
	'ERROR_DEFAULT_CHARSET'							=> 'Подразумевани карсет није исправно конфигурисан',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> '<var>default_charset</var> мора бити постављено на <samp>UTF-8</samp>. Можете проверити тренутну вредност на <samp>PHP подаци</samp> page.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'			=> '<strong>Додате или учитане дозволе’ приступа форуму корисницима</strong> за %1$s<br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'			=> '<strong>Додате или учитане дозволе’ приступа форуму уредницима</strong> за %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>Додате или учитане групне’ дозволе приступа форуму</strong> за %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>Додате или учитане групне’ дозволе приступа форуму уредницима</strong> за %1$s<br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Додати или учитани Уредници</strong> за %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Додате или учитане дозволе форума</strong> за %1$s<br />» %2$s',
	...
	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> 'Spamhaus не дозвољава задатке који користе отворену обраду. Провера црне листе је онемогућена. За више информација, погледајте https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> 'Spamhaus ограничење обима задатака је достигнуто. Провера црне листе је онемогућена. За више информација, погледајте https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
