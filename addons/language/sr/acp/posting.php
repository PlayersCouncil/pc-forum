...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> 'ББКод који покушаватзе да додате изгледа небезбедно. Уколико ББКод користи {TEXT} симбол у осетљивом контексту, пробајте да користите рестриктивнији тип уместо тога. Наставите само ако разумете укључене ризике.',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Било какав текст, укључујући стране знакове, бројеве, итд…',
		...
		'URL'			=> 'Исправан URL користећи било који дозвољени протокол (http, ftp, итд… не може бити коришћен за javascript). Ако ништа није дато, “http://” је префикс стринга.',
		...
		'ALNUM'			=> 'Знакови латинице (A-Z) и бројеви.',
		'CHOICE'		=> 'Избор посебних вредности, н.пр. <samp>{CHOICE=spades,hearts,diamonds,clubs}</samp>. Вредности се сматрају за неосетљиве на велика и мала слова као подразумевано и могу бити сматране осетљивима означавањем <samp>caseSensitive</samp> могућности: <samp>{CHOICE=Spades,Hearts,Diamonds,Clubs;caseSensitive}</samp>',
		'FLOAT'			=> 'Децимална вредност, н.пр. <samp>0.5</samp>.',
		'HASHMAP'		=> 'Мапира стрингове у њихове замене у облику <samp>{HASHMAP=string1:replacement1,string2:replacement2}</samp>. Осетљиво на велика и мала слова. Задржава непознате вредности као подразумевано.',
		'INT'			=> 'Целобројна вредност, н.пр. <samp>2</samp>.',
		'IP'			=> 'Ваљана IPv4 или IPv6 адреса.',
		'IPPORT'		=> 'Ваљана IPv4 или IPv6 адреса са бројем порта.',
		'IPV4'			=> 'Ваљана IPv4 адреса.',
		'IPV6'			=> 'Ваљана IPv6 адреса.',
		'MAP'			=> 'Мапира стрингове у њихове замене у облику <samp>{MAP=string1:replacement1,string2:replacement2}</samp>. Неосетљиво на велика и мала слова. Задржава непознате вредности као подразумевано.',
		'RANGE'			=> 'Прихвата целобројне вредности унутар датог опсега, н.пр. <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Проверава његову вредност у односу на дати` regexp, н.пр. <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'Време као <samp>1h30m10s</samp> ће бити пребачено у број секунди. Такође прихвата број.',
		'UINT'			=> 'Недодељена целобројна вредност. Исто као <samp>{INT}</samp>, али одбија вредности мање од 0.',
	),
));
