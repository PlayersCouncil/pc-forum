...
$lang = array_merge($lang, array(
	...
	'PRIVACY_POLICY'		=> 'Ова полиса подробно објашњава како “%1$s” заједно са његовим припојеним компанијама (у даљем тексту “ми”, “нас”, “наш”, “%1$s”, “%2$s”) и phpBB (у даљем тексту “оне”, “њих”, “њихов”, “phpBB програм”, “www.phpbb.com”, “phpBB Limited”, “phpBB Тимови”) користе било какве податке прикупљене током било које ваше корисничке сесије (у даљем тексту “ваши подаци”).
	<br><br>
	Ваши подаци се сакупљају на два начина. Прво, прегледање “%1$s” ће проузроковати да phpBB програм направи неколико колачића, који су мале текстуалне датотеке које се преузимају у фасциклу веб прегледача на вашем рачунару. Прва два колачића садрже само ознаку корисника (у даљем тексту “user-id”) и ознаку анонимне сесије (у даљем тексту “session-id”), која вам се аутоматски додељује од phpBB програма. Трећи колачић ће бити направљен када будете прегледали теме у “%1$s” и користи да сачува податке о темама које сте прочитали, побољшавајући тако ваше коришћење.
	<br><br>
	Ми можемо такође да направимо колачиће ван phpBB програма док прегледате “%1$s”, иако су они ван домашаја овог документа који је намењен само да покрије странице направљене од phpBB програма. Други начин на који сакупљамо ваше податке је оно што ви нама пошаљете. Ово може бити, и није ограничено на: писање као анонимни корисник (у даљем тексту “анонимне поруке”), регистровање на “%1$s” (у даљем тексту “ваш налог”) и поруке које сте ви послали након регистрације и док сте пријављени (у даљем тексту “ваше поруке”).
	<br><br>
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'Хвала вам што сте се регистровали, ваш налог је направљен.',
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Синтакса користи исти облик као и PHP <a href="https://www.php.net/manual/datetime.format.php">датум функција</a>.',
	...
	'FOES_EXPLAIN'				=> 'Занемарени су корисници који ће бити занемарени по подразумеваном. Поруке од тих корисника неће бити потпуно видљиве. Приватне поруке од занемарених још увек су допуштене. Молимо знајте да не можете занемаривати уреднике или администраторе.',
	...
	'NOTIFICATION_TYPE_FORUM'							=> 'Неко је одговорио на тему у форуму који пратите',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Ваша пријава поруке је затворена од уредника',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Неко пријављује приватну поруку',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Ваша пријава приватне поруке је затворена од уредника',
	...
	'NO_RESET_TOKEN'			=> 'Нисте пружили симбол за васпостављање лозинке.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Лозинка мора бити бар %1$s дугачка, мора садржати велика и мала слова и мора садржати бројеве.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Мора бити бар %1$s дугачка.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Лозинка мора бити бар %1$s дугачка и мора садржати велика и мала слова.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Лозинка мора бити бар %1$s дугачка, мора садржати велика и мала слова, мора садржати бројеве и мора садржати симболе.',
	'PASSWORD'					=> 'Лозинка',
	'PASSWORD_ACTIVATED'		=> 'Ваша нова лозинка је активирана.',
	'PASSWORD_RESET'			=> 'Ваша лозинка је успешно васпостављена.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Уколико ваш налог постоји, веза за васпостављање лозинке је послата на вашу регистровану мејл адресу. Уколико не добијете мејл, то може бити зато што сте под забраном, ваш налог није активиран, захтевали сте вишеструко васпостављање лозинке за кратко време, или вам није дозвољено да промените лозинку. ПОвежите се са администратором ако постоји и један од ових разлога. Такође, молимо проверите да мејл можда није ухватио ваш спам пречистач.',
	...
	'OAUTH_REGISTRATION'				=> 'Регистрација користећи спољашње услуге',
	...
	'RESET_PASSWORD'					=> 'Васпостави лозинку',
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Симбол за васпостављање лозинке који сте пружили није ваљан или је истекао.',
