...
$lang = array_merge($lang, array(
	...
	'DEFAULT_SEARCH_RETURN_CHARS'			=> '返回的字元數之預設值',
	'DEFAULT_SEARCH_RETURN_CHARS_EXPLAIN'	=> '搜尋時將返回的預設字元數。設定為 0 將返回整篇文章。',
	'DELETE_INDEX'							=> '刪除索引',
	'DELETING_INDEX_IN_PROGRESS'			=> '正在刪除索引...',
	...
	'SEARCH_INDEX_CREATE_REDIRECT'			=> array(
		1	=> '所有 id 直到 %2$d 的文章都已經建立索引，這一階段處理了 %1$d 篇文章。',
	),
	'SEARCH_INDEX_CREATE_REDIRECT_RATE'		=> array(
		1	=> '目前索引的比率接近每秒 %1$.1f 篇文章。',
	),
	'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		1	=> '所有 id 直到 %2$d 的文章都已經從搜尋索引中移除，這一階段處理了 %1$d 篇文章。',
	),
	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		1	=> '目前刪除的比率接近每秒 %1$.1f 篇文章。',
	),
	'SEARCH_INDEX_CREATED'					=> '在資料庫中所有文章已經建立索引成功。',
	'SEARCH_INDEX_PROGRESS'					=> '完成：%1$d | 待處理：%2$d | 總計：%3$d',
