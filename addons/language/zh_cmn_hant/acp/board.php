...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> '語法使用與 PHP <a href="https://www.php.net/manual/datetime.format.php">日期函數</a>相同的格式。',
	...
	'DISPLAY_LAST_SUBJECT'			=> '顯示最後發表的文章主題',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> '最後發表的主題名稱將會加上超連結後顯示於版面列表。有密碼保護的版面以及不具有閱讀權限的會員將不會顯示文章主題。',
	'DISPLAY_UNAPPROVED_POSTS'		=> '向作者顯示未核准的文章',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> '作者可以查看未核准的文章。不適用於訪客文章。',
	'GUEST_STYLE'					=> '訪客風格',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM_REPORT_EXPLAIN'	=> '如果啟用，那麼會員將有檢舉他們已接收私人訊息或傳送給討論區版主的選項。這些私人訊息將會顯示在 MCP 中。',
	'ALLOW_QUICK_REPLY'			=> '允許快速回覆',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> '這個設定允許在整個討論區禁用快速回覆。當啟用時，版面個別設定將決定快速回覆是否顯示於個別的版面。',
	...
	'ALLOW_BOARD_NOTIFICATIONS' => '允許討論區通知',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AVATARS'					=> '啟用頭像',
	'ALLOW_AVATARS_EXPLAIN'			=> '允許一般頭像的使用；<br>如果您停用一般頭像或某些模式的頭像，這被停用的頭像將不再顯示於討論區上，但是會員仍然可由 UCP 下載他們自己的頭像。',
	'ALLOW_GRAVATAR'				=> '啟用 Gravatar 頭像',
	'ALLOW_LOCAL'					=> '允許使用系統相簿頭像',
	'ALLOW_REMOTE'					=> '允許使用外部連結頭像',
	'ALLOW_REMOTE_EXPLAIN'			=> '頭像連結來自其他網站。<br><em><strong class="error">警告：</strong>啟用此功能，將允許會員檢查檔案的存在，以及只能在本地網絡上訪問的服務。</em>',
	'ALLOW_REMOTE_UPLOAD'			=> '允許使用外部連結上傳頭像',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> '允許自另外的網站上傳頭像。<br><em><strong class="error">警告：</strong>啟用此功能，將允許會員檢查檔案的存在，以及只能在本地網絡上訪問的服務。</em>',
...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> '允許方案的連結',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> '會員只能發表無架構網址或以逗號分隔的允許方案列表之一。',
	...
	'MAX_POST_IMG_HEIGHT'			=> '每篇文章的最大動畫之高度',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> '發文時允許一個動畫的最大高度。設定為 0，表示沒有限制。',
	'MAX_POST_IMG_WIDTH'			=> '每篇文章的最大動畫之寬度',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> '發文時允許一個動畫的最大寬度。設定為 0，表示沒有限制。',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION'			=> '帳號啟用',
	'ACC_ACTIVATION_EXPLAIN'	=> '這決定了會員是否可以在註冊後立刻登入討論區，還是必須進行確認。您也可以完全地停止新的註冊。<em>若設定為由管理員或由會員啟用，則必需啟用「允許討論區發送電子郵件」。</em>',
	'ACC_ACTIVATION_WARNING'		=> '請注意，目前選擇的帳號啟用方法需要啟用「允許討論區發送電子郵件」，否則註冊將被停用。建議您選擇不同的帳號啟用方法或重新啟用「允許討論區發送電子郵件」。',
	...
	'ACC_USER'					=> '由會員（透過註冊的電子郵件啟用）',
//	'ACC_USER_ADMIN'			=> '會員 + 管理員',
	'ALLOW_EMAIL_REUSE'			=> '允許電子郵件位址重複使用',
	'ALLOW_EMAIL_REUSE_EXPLAIN'	=> '不同的會員可以使用相同的電子郵件位址註冊。',
	'COPPA'						=> 'COPPA',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> '密碼的最少字元數。注意，最大數量不受限制。',
	'REG_LIMIT'					=> '註冊嘗試次數',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> '開啟或關閉整個討論區的 ATOM 消息來源。<br>無論底下的選項設定為何，停用這個將關閉所有的消息來源。',
	'ACP_FEED_LIMIT'					=> '項目數量',
	'ACP_FEED_LIMIT_EXPLAIN'			=> '消息來源項目所顯示的最大數量。',

	'ACP_FEED_OVERALL'					=> '啟用整個討論區之消息來源',
	'ACP_FEED_OVERALL_EXPLAIN'			=> '整個討論區之新的文章。',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_SELECT_EXPLAIN'				=> '由下拉式選單中選取討論區所認證的外掛。灰色的項目目前是沒有用的，而在使用前必須調整基本組態。',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> '這些細節定義發送 Cookies 到會員瀏覽器的資料。在大部分情況下設定 Cookie 預設值應該是足夠的。如果您需要做任何改變，那麼得謹慎，不正確的設定將使會員無法登入討論區。如果您的會員在登入論壇時遇到問題，請訪問 <strong><a href="https://www.phpbb.com/support/go/cookie-settings/">phpBB.com Knowledge Base - Fixing incorrect cookie settings</a></strong>。',

	'COOKIE_DOMAIN'				=> 'Cookie 網域',
	'COOKIE_DOMAIN_EXPLAIN'		=> '在大多數情況下，Cookie 網域是可選的。如果您不確定，請將其留白。<br><br>如果您將討論區與其他軟體集成或具有多個網域，則要確定 Cookie 網域，您需要執行以下操作。如果您有類似 <i>example.com</i> 和 <i>forums.example.com</i>，或可能是 <i>forums.example.com</i> 和 <i>blog.example.com</i>。刪除子網域名，直到找到公共網域，<i>example.com</i>。現在在公共網域前面增加一個點，您將輸入 .example.com（注意開始的點）。',
	'COOKIE_NAME'				=> 'Cookie 名稱',
	'COOKIE_NAME_EXPLAIN'		=> '這可以是任何你想要的，使它成為原創。每當 Cookie 設定被更改時，Cookie 名稱也應該被改變。',
	'COOKIE_NOTICE'				=> 'Cookie 通知',
	'COOKIE_NOTICE_EXPLAIN'		=> '如果啟用，當用戶訪問您的討論區時將顯示 Cookie 通知。這可能是法律要求的，具體取決於您的討論區和已啟用的擴充功能之內容。',
	'COOKIE_PATH'				=> 'Cookie 路徑',
	'COOKIE_PATH_EXPLAIN'		=> '這通常會與您的 script 路徑相同，或者只是一個斜線，以使 Cookie 可以訪問整個站點網域。',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> '這將會允許使用者發送電子郵件給討論區管理員。請注意，必須啟用「允許討論區發送電子郵件」選項。 您可以在「一般 &gt; 客戶端通訊 &gt; 電子郵件設定」中找到此選項。',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> '如果啟用此設定，某些檔案將從外部第三方服務器而不是您的伺服器提供。這會減少伺服器使用的網絡頻寬，但在某些國家可能會出現隱私問題。在預設的 phpBB 安裝中，這包括從 Google 的內容分發網絡加載「jQuery」和字體「Open Sans」。這也適用於「Font Awesome」字體，phpBB 和一些擴展功能使用它來呈現圖標。',	
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> '會員的活動之文章限制',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> '對於擁有超過文章數目的會員，不會顯示最常討論的主題/版面。設定為 0 以禁用限制。',
	...
	'YES_ACCURATE_PM_BUTTON'			=> '在主題頁面中啟用特定的權限之 PM 按鈕',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> '如果啟用此設定，則只有被允許閱讀私人訊息的使用者之文章旁才會有私人訊息按鈕。',
...
$lang = array_merge($lang, array(
	...
	'APACHE_SETUP_BEFORE_USE'	=> '在您轉換 phpBB 到這個認證方式以前，您必須安裝 apache 認證。記住！您用於 apache 認證的會員名稱必須和 phpBB 的會員名稱相同。Apache 認證只能用於 mod_php (不含 CGI 版本)。',

	'LDAP'							=> 'LDAP',
	'LDAP_DN'						=> 'LDAP 基礎 <var>dn</var>',
	'LDAP_DN_EXPLAIN'				=> '這是個卓越的名字 (Distinguished Name)，用來指出會員資訊，例如：<samp>o=My Company,c=US</samp>。',
	'LDAP_EMAIL'					=> 'LDAP 電子郵件屬性',
	'LDAP_EMAIL_EXPLAIN'			=> '設定它為您會員輸入的電子郵件屬性名稱（如果存在的話），以便於為新會員自動設定電子郵件位址，留空的話將導致第一次登入的會員之電子郵件位址為空。',
	'LDAP_INCORRECT_USER_PASSWORD'	=> '使用特定的會員名稱/密碼連結 LDAP 伺服器失敗。',
	'LDAP_NO_EMAIL'					=> '特定的電子郵件屬性不存在。',
...
// Server Settings
$lang = array_merge($lang, array(
	'ACP_SERVER_SETTINGS_EXPLAIN'	=> '在這裡，您可以定義伺服器和網域名稱相關的設定。請確認您所輸入的資料是正確的，錯誤的設定將導致電子郵件包含不正確的資訊。當輸入網域名稱時，記住不包含 http:// 或其他通訊協議。如果您知道您的伺服器使用一個不同的連接埠時，那麼才需要更改埠號，絕大部分使用的連接埠號都是 80。',
	...
	'SERVER_NAME'				=> '網域名稱',
	'SERVER_NAME_EXPLAIN'		=> '討論區所在的網域名稱 (例如：<samp>example.com</samp>)。',
	'SERVER_PORT'				=> '伺服器連接埠',
	...
	'USE_SYSTEM_CRON'			=> '從作業系統 cron 運行定期任務',
	'USE_SYSTEM_CRON_EXPLAIN'	=> '當停用時，phpBB 將安排定期任務自動執行。啟用後，phpBB 將不會自行安排任何定期任務；系統管理員必須排程作業系統 cron 工具定期（例如每 5 分鐘）執行 <code>bin/phpbbcli.php cron:run</code>。',
));
...
$lang = array_merge($lang, array(
	...
	'CLASS_B'						=> 'A.B',
	'CLASS_C'						=> 'A.B.C',
	'EMAIL_CHECK_MX'				=> '檢查電子郵件網域名稱之有效的 MX 記錄',
	'EMAIL_CHECK_MX_EXPLAIN'		=> '如果啟用，那麼會員在註冊和修改個人資料時所提供的電子郵件網域名稱之有效的 MX 記錄將被檢查。',
	...
	'UPLOAD_CERT_VALID'				=> '驗證上傳證書',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> '如果啟用，那麼將驗證遠端上傳的證書。這需要在您的 php.ini 中，由 <samp>openssl.cafile</samp> 或 <samp>curl.cainfo</samp> 設定以定義 CA 軟件包。',
));

// Email Settings
$lang = array_merge($lang, array(
	'ACP_EMAIL_SETTINGS_EXPLAIN'	=> '這個資訊用於當討論區向您的會員發送電子郵件時。請確認您所指定電子郵件位址是有效的，任何被退回或無法投遞的訊息都將被發送到那個位址。如果您的主機不提供本地（基於 PHP 的）電子郵件服務，那麼您可以直接使用 SMTP 發送訊息。這需要合適的伺服器位址（假如不清楚，請詢問提供者）。如果伺服器需要驗證（並且只有在需要時）那麼輸入必要的會員名稱、密碼以及驗證方式。',

	'ADMIN_EMAIL'					=> '從電子郵件位址',
	'ADMIN_EMAIL_EXPLAIN'			=> '這將是所有的電子郵件、技術聯繫電子郵件之寄件者位址。在電子郵件中，它將用於 <samp>Sender</samp>。',
	'BOARD_EMAIL_FORM'				=> '會員經由討論區發送電子郵件',
	'BOARD_EMAIL_FORM_EXPLAIN'		=> '會員能夠經由討論區發送電子郵件而不顯示他們的電子郵件位址。',
	'BOARD_HIDE_EMAILS'				=> '隱藏電子郵件位址',
	'BOARD_HIDE_EMAILS_EXPLAIN'		=> '這個功能保持電子郵件位址完全隱密。',
	'CONTACT_EMAIL'					=> '聯絡電子郵件位址',
	'CONTACT_EMAIL_EXPLAIN'			=> '這個位址將使用在任何需要指定聯絡地點的場合，例如：廣告信、錯誤輸出、...等。在電子郵件中，它將用於 <samp>From</samp> 和 <samp>Reply-To</samp>。',
	'CONTACT_EMAIL_NAME'			=> '聯絡人姓名',
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> '電子郵箱的收件人將會看到聯絡人的姓名。如果你不希望有聯絡人姓名，請保留此字段為空白。',
	'EMAIL_FORCE_SENDER'			=> '強制從電子郵件位址',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> '這會將<samp> Return-Path </samp>設定為寄件者電子郵件位址，而不是使用本地用戶和伺服器的主機名稱。使用 SMTP 時，此設定不適用。<br><em><strong>警告：</strong>要求運行網絡伺服器的用戶，作為可信任用戶添加到發送郵件配置中。</em>',
	'EMAIL_PACKAGE_SIZE'			=> '電子郵件包裹大小',
	'EMAIL_PACKAGE_SIZE_EXPLAIN'	=> '這是在一個包裹中允許的最大電子郵件數量。這個設定適用於內部訊息審核；如果您有收到無法傳送的通知，那麼設定為 0。',
	'EMAIL_MAX_CHUNK_SIZE'			=> '允許的電子郵件收件人之最大數量',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> '如有必要，請將此值設定為不超過電子郵件伺服器在一封電子郵件中允許的收件人之最大數量。',
	'EMAIL_SIG'						=> '電子郵件簽名',
	'EMAIL_SIG_EXPLAIN'				=> '這段文字將附加在討論區所有發送的電子郵件中。',
	'ENABLE_EMAIL'					=> '允許討論區發送電子郵件',
	'ENABLE_EMAIL_EXPLAIN'			=> '如果停用，那麼將沒有任何電子郵件會被討論區發送。<em>注意！由會員或管理員啟用帳號的設定者，必須啟用這個設定。否則如果停用此設定，那麼註冊將被停用。</em>',
	'SEND_TEST_EMAIL'				=> '發送測試電子郵件',
	'SEND_TEST_EMAIL_EXPLAIN'		=> '這將向您帳戶中定義的郵件位址發送測試電子郵件。',
	'SMTP_ALLOW_SELF_SIGNED'		=> '允許自行簽名 SSL 證書',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> '允許使用自行簽名 SSL 證書連接到 SMTP 伺服器。<br><em><strong>警告：</strong>允許自行簽名 SSL 證書可能會導致安全隱患。</em>',
	...
	'SMTP_PASSWORD_EXPLAIN'			=> '只有當您的 SMTP 伺服器需要密碼時，才要輸入。<br><em><strong>警告：</strong>這個密碼以純文字格式儲存在資料庫中。</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
	'SMTP_POP_BEFORE_SMTP'			=> 'POP-BEFORE-SMTP',
	'SMTP_PORT'						=> 'SMTP 伺服器連接埠',
	'SMTP_PORT_EXPLAIN'				=> '只有在您知道您的 SMTP 伺服器運行在一個不同的連接埠時才需要變更。',
	'SMTP_SERVER'					=> 'SMTP 伺服器位址',
	'SMTP_SERVER_EXPLAIN'			=> '除非您的郵件主機告訴您這樣做，否則不要提供協議（<samp>ssl://</samp> 或 <samp>tls://</samp>）。',
	'SMTP_SETTINGS'					=> 'SMTP 設定',
	'SMTP_USERNAME'					=> 'SMTP 會員名稱',
	'SMTP_USERNAME_EXPLAIN'			=> '只有當您的 SMTP 伺服器需要它時才要輸入。',
	'SMTP_VERIFY_PEER'				=> '驗證 SSL 證書',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> '要求驗證 SMTP 伺服器使用的 SSL 證書。<br><em><strong>警告：</strong>連接具有未驗證 SSL 證書的對等體可能會導致安全隱患。</em>',
	'SMTP_VERIFY_PEER_NAME'			=> '驗證 SMTP 對等體名稱',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> '要求使用 SSL / TLS 連接以驗證 SMTP 伺服器的對等名稱。<br><em><strong>警告：</strong>連接具有未驗證 SSL 證書的對等體可能會導致安全隱患。</em>',
	'TEST_EMAIL_SENT'				=> '測試電子郵件已發送。<br>如果您沒有收到，請檢查您的電子郵件設定。<br><br>如果您需要幫助，請訪問<a href="https://www.phpbb.com/community/">phpBB support forums</a>。',

	'USE_SMTP'						=> '使用 SMTP 伺服器發送電子郵件',
	'USE_SMTP_EXPLAIN'				=> '選擇「是」，如果您想要或必須經由 SMTP 伺服器而不是本地的信件函數發送電子郵件。',
));
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> '允許自行簽名 SSL 證書',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> '允許使用自行簽名 SSL 證書連接到 Jabber 伺服器。<br><em><strong>警告：</strong>允許自行簽名 SSL 證書可能會導致安全隱患。</em>',
	...
	'JAB_VERIFY_PEER'				=> '驗證 SSL 證書',
	'JAB_VERIFY_PEER_EXPLAIN'		=> '要求驗證 Jabber 伺服器使用的 SSL 證書。<br><em><strong>警告：</strong>連接具有未驗證 SSL 證書的對等體可能會導致安全隱患。</em>',
	'JAB_VERIFY_PEER_NAME'			=> '驗證 Jabber 對等體名稱',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> '要求使用 SSL / TLS 連接以驗證 Jabber 伺服器的對等名稱。<br><em><strong>警告：</strong>連接具有未驗證 SSL 證書的對等體可能會導致安全隱患。</em>',
));
