...
$lang = array_merge($lang, array(
	...
	'IMAGE_QUALITY'				=> '上傳圖片附加檔案的質量（僅 JPEG）',
	'IMAGE_QUALITY_EXPLAIN'		=> '指定介於 50%（較小的檔案尺寸）和 90%（較高的質量）之間的值。高於 90% 的質量會增加檔案尺寸而被禁用。只有當最大圖檔尺寸設定為 0 x 0 以外的值時，此設定才適用。',
	'IMAGE_STRIP_METADATA'		=> '剝離圖檔元數據（僅 JPEG）',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> '剝離 Exif 元數據，例如作者姓名、GPS 座標和相機詳細資料。只有當最大圖檔尺寸設定為 0 x 0 以外的值時，此設定才適用。',
	...
	'NO_EXT_GROUP'				=> '沒有',
	'NO_EXT_GROUP_ALLOWED_PM'	=> '沒有用於私訊之<a href="%s">允許的擴充群組</a>。',
	'NO_EXT_GROUP_ALLOWED_POST'	=> '沒有用於文章之<a href="%s">允許的擴充群組</a>。',
	...
	'UPLOAD_POST_NOT_EXIST'			=> '檔案「%1$s」無法上傳到文章 ID %2$d，因為該文章不存在。',
));
