...
$lang = array_merge($lang, array(
	...
	'EXTENSIONS_EXPLAIN'        => '在您的討論區中，這個工具允許您管理所有的擴充功能情況，以及檢視其相關資訊。',
	'EXTENSION_INVALID_LIST'    => '這「%s」擴充功能是無效的。<br />%s<br /><br />',
	'EXTENSION_NOT_AVAILABLE'   => '所選擇的擴充功能無法在這個討論區使用，請確認您的 phpBB 和 PHP 版本是允許的（見詳細內容頁）。',
	'EXTENSION_DIR_INVALID'     => '所選擇的擴充功能具有無效的目錄結構，並不能被啟用。',
	'EXTENSION_NOT_ENABLEABLE'	=> '所選擇的擴充功能不能被啟用，請確認擴充功能的需求。',
	'EXTENSION_NOT_INSTALLED'	=> '這「%s」擴充功能無法使用。請檢查您是否正確安裝。',

	'DETAILS'               => '詳細內容',

	'EXTENSIONS_NOT_INSTALLED'	=> '未安裝的擴充功能',
	...
	'EXTENSION_ENABLE_EXPLAIN'      => '啟用擴充功能允許您在討論區使用它。',
	...
	'EXTENSION_INSTALL_HEADLINE'=> '安裝擴充功能中',
	'EXTENSION_INSTALL_EXPLAIN'	=> '<ol>
			<li>從 phpBB 的擴充功能資料庫下載之</li>
			<li>解壓縮，以及上傳到您的 phpBB 討論區的 <samp>ext/</samp> 資料夾</li>
			<li>由此擴充功能管理器，啟用之</li>
		</ol>',
	...
	'EXTENSION_REMOVE_HEADLINE' => '從您的討論區完全地移除擴充功能',
	...
	'BROWSE_EXTENSIONS_DATABASE'		=> '瀏覽擴充功能資料庫',
