...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>需要瞭解您的 phpBB3 討論區更多的權限設定和管理資訊，請參訪在 <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">Setting permissions of our Quick Start Guide</a> 的章節。</p>
	',

	'ACL_NEVER'				=> '從不',
	'ACL_SET'				=> '權限設定',
	'ACL_SET_EXPLAIN'		=> '權限基於簡單的 <strong>是</strong>/<strong>否</strong> 系統。設定會員或群組會員選項為 <strong>從不</strong> 將覆蓋其他設定的值。如果您不想要給這個會員或群組會員設定值，請選擇 <strong>否</strong>。如果值在其他地方設定，他們將在設定中使用，否則請選擇 <strong>從不</strong>。所有選擇的對象（他們前面的勾選框）將複製您設定的權限。請注意，為創始人帳戶設定管理權限不會產生任何影響，因為創始人的管理員權限始終設定為<strong>是</strong>。',
	'ACL_SETTING'			=> '設定',
	...
	'ROLE_DESCRIPTION_USER_LIMITED'			=> '可以使用某些會員的功能。發表附加檔案、發送電子郵件或私人訊息是不允許的。',
